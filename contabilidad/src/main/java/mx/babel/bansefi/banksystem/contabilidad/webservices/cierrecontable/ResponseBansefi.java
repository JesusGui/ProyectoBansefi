 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_CIERRE_OFICINA_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrcierreoficinatrno"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_CIERRE_OFICINA_TRN_O", required = true)
    protected ResponseBansefi.OTRCIERREOFICINATRNO otrcierreoficinatrno;

    /**
     * Obtiene el valor de la propiedad otrcierreoficinatrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRCIERREOFICINATRNO }
     *     
     */
    public ResponseBansefi.OTRCIERREOFICINATRNO getOTRCIERREOFICINATRNO() {
        return otrcierreoficinatrno;
    }

    /**
     * Define el valor de la propiedad otrcierreoficinatrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRCIERREOFICINATRNO }
     *     
     */
    public void setOTRCIERREOFICINATRNO(ResponseBansefi.OTRCIERREOFICINATRNO value) {
        this.otrcierreoficinatrno = value;
    }
    ...
    public static class OTRCIERREOFICINATRNO {

        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNOPARMV stdtrnoparmv;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNOPARMV value) {
         ...
         * {@link ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRCIERREOFICINATRNO.STDTRNMSJPARMV>();
            }
