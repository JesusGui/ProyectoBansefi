...
import mx.babel.bansefi.banksystem.contabilidad.webservices.altaapuntemanualcaja.AltaApunteManualCajaServicio;
import mx.babel.bansefi.banksystem.contabilidad.webservices.altaapuntemanualcaja.Ejecutar;
import mx.babel.bansefi.banksystem.contabilidad.webservices.altaapuntemanualcaja.Ejecutar.ITRAMINIAPNTEMANOTRN.TRAMINIAPNTEMANOEVT.AMAPNTEMANUALE;
import mx.babel.bansefi.banksystem.contabilidad.webservices.altaapuntemanualcaja.Ejecutar.ITRAMINIAPNTEMANOTRN.TRAMINIAPNTEMANOEVT.CONINDFECHCRREV;
import mx.babel.bansefi.banksystem.contabilidad.webservices.altaapuntemanualcaja.EjecutarResult;
import mx.babel.bansefi.banksystem.contabilidad.webservices.altaapuntemanualcaja.ResponseBansefi;
import mx.babel.bansefi.banksystem.contabilidad.wrappers.AltaApunteManualCajaWrapper;
...
@Component
public class AltaApunteManualCajaBackEnd extends BackEndBean implements
		Serializable {
	...
	@Autowired
	private AltaApunteManualCajaWrapper altaApunteManualWrapper;

	private static final Logger LOGGER = LogManager
			.getLogger(AltaApunteManualCajaBackEnd.class);
	...
	private EjecutarResult ejecutarWS(Ejecutar.ITRAMINIAPNTEMANOTRN contexto) {
		...
		try {
			respuesta = (EjecutarResult) this.servicioWebUtils.ejecutarWS(
					AltaApunteManualCajaServicio.class, contexto);
