...
public class ModificacionCentroServicio extends Service {
    ...
    public final static QName SERVICE = new QName(ServicioWebConstants.TARGETNAMESPACE_TRN + "TR_MODI_CENTRO_TRN", "TR_MODI_CENTRO_TRN");
    public final static QName SOAPPORT = new QName(ServicioWebConstants.TARGETNAMESPACE_TRN + "TR_MODI_CENTRO_TRN", "SoapPort");
    static {
        URL url = null;
        try {
            url = new URL(ServicioWebConstants.URL_WSDL+"TR_MODI_CENTRO_TRN/WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ModificacionCentroServicio.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", ServicioWebConstants.URL_WSDL+"TR_MODI_CENTRO_TRN/WSDL");
        }
        WSDL_LOCATION = url;
    }
