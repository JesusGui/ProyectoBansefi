 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_EP_MODIF_ATRIB_EMPL_T">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrepmodifatribemplt"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_EP_MODIF_ATRIB_EMPL_T", required = true)
    protected ResponseBansefi.OTREPMODIFATRIBEMPLT otrepmodifatribemplt;

    /**
     * Obtiene el valor de la propiedad otrepmodifatribemplt.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTREPMODIFATRIBEMPLT }
     *     
     */
    public ResponseBansefi.OTREPMODIFATRIBEMPLT getOTREPMODIFATRIBEMPLT() {
        return otrepmodifatribemplt;
    }

    /**
     * Define el valor de la propiedad otrepmodifatribemplt.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTREPMODIFATRIBEMPLT }
     *     
     */
    public void setOTREPMODIFATRIBEMPLT(ResponseBansefi.OTREPMODIFATRIBEMPLT value) {
        this.otrepmodifatribemplt = value;
    }
    ...
    public static class OTREPMODIFATRIBEMPLT {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_EP_MODIF_ATRIB_EMPL_EV", required = true)
        protected ResponseBansefi.OTREPMODIFATRIBEMPLT.TREPMODIFATRIBEMPLEV trepmodifatribemplev;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTREPMODIFATRIBEMPLT.TREPMODIFATRIBEMPLEV }
         *     
         */
        public ResponseBansefi.OTREPMODIFATRIBEMPLT.TREPMODIFATRIBEMPLEV getTREPMODIFATRIBEMPLEV() {
         ...
         *     
         */
        public void setTREPMODIFATRIBEMPLEV(ResponseBansefi.OTREPMODIFATRIBEMPLT.TREPMODIFATRIBEMPLEV value) {
         ...
         * {@link ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTREPMODIFATRIBEMPLT.STDTRNOPARMV value) {
