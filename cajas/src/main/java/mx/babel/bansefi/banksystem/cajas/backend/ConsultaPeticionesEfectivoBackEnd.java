...
import mx.babel.bansefi.banksystem.cajas.webservice.consultapeticionesefectivo.ConsultaPeticionesEfectivoServicio;
import mx.babel.bansefi.banksystem.cajas.webservice.consultapeticionesefectivo.Ejecutar;
import mx.babel.bansefi.banksystem.cajas.webservice.consultapeticionesefectivo.EjecutarResult;
import mx.babel.bansefi.banksystem.cajas.webservice.consultapeticionesefectivo.ResponseBansefi;
import mx.babel.bansefi.banksystem.cajas.webservice.consultapeticionesefectivo.ResponseBansefi.OTRAUTINICPETCNSMTRN.EXEXISTDESGLSE;
import mx.babel.bansefi.banksystem.cajas.webservice.consultapeticionesefectivo.ResponseBansefi.OTRAUTINICPETCNSMTRN.SMSOLCTDESGLSE;

@Component
public class ConsultaPeticionesEfectivoBackEnd  extends BackEndBean{
	...
	private EjecutarResult ejecutarWS(Ejecutar.ITRAUTINICPETCNSMTRN contexto){
		...
		try{
			respuesta = (EjecutarResult) servicioWebUtils.ejecutarWS(ConsultaPeticionesEfectivoServicio.class, contexto);
