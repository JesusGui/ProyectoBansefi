 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_AJUSTE_DESGLS_EX_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_AJUSTE_DESGLS_EX_EVT_Z" maxOccurs="50">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrajustedesglsextrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_AJUSTE_DESGLS_EX_TRN", required = true)
    protected ResponseBansefi.OTRAJUSTEDESGLSEXTRN otrajustedesglsextrn;

    /**
     * Obtiene el valor de la propiedad otrajustedesglsextrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRAJUSTEDESGLSEXTRN }
     *     
     */
    public ResponseBansefi.OTRAJUSTEDESGLSEXTRN getOTRAJUSTEDESGLSEXTRN() {
        return otrajustedesglsextrn;
    }

    /**
     * Define el valor de la propiedad otrajustedesglsextrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRAJUSTEDESGLSEXTRN }
     *     
     */
    public void setOTRAJUSTEDESGLSEXTRN(ResponseBansefi.OTRAJUSTEDESGLSEXTRN value) {
        this.otrajustedesglsextrn = value;
    }
    ...
    @XmlType(name = "", propOrder = {
        "rtrncd",
        "numberofrecords",
        "trajustedesglsexevtz",
        "stdtrnmsjparmv",
        "stdtrnoparmv"
    })
    public static class OTRAJUSTEDESGLSEXTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "NUMBER_OF_RECORDS")
        protected int numberofrecords;
        @XmlElement(name = "TR_AJUSTE_DESGLS_EX_EVT_Z", required = true)
        protected List<ResponseBansefi.OTRAJUSTEDESGLSEXTRN.TRAJUSTEDESGLSEXEVTZ> trajustedesglsexevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Gets the value of the trajustedesglsexevtz property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the trajustedesglsexevtz property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getTRAJUSTEDESGLSEXEVTZ().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ResponseBansefi.OTRAJUSTEDESGLSEXTRN.TRAJUSTEDESGLSEXEVTZ }
         * 
         * 
         */
        public List<ResponseBansefi.OTRAJUSTEDESGLSEXTRN.TRAJUSTEDESGLSEXEVTZ> getTRAJUSTEDESGLSEXEVTZ() {
            if (trajustedesglsexevtz == null) {
                trajustedesglsexevtz = new ArrayList<ResponseBansefi.OTRAJUSTEDESGLSEXTRN.TRAJUSTEDESGLSEXEVTZ>();
            }
            return this.trajustedesglsexevtz;
        }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRAJUSTEDESGLSEXTRN.STDTRNOPARMV value) {
        ...
        public static class TRAJUSTEDESGLSEXEVTZ {
