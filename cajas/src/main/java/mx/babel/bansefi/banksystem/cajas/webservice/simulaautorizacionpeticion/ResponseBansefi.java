 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_AUT_SMLCN_PETCN_SM_TR">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrautsmlcnpetcnsmtr"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_AUT_SMLCN_PETCN_SM_TR", required = true)
    protected ResponseBansefi.OTRAUTSMLCNPETCNSMTR otrautsmlcnpetcnsmtr;

    /**
     * Obtiene el valor de la propiedad otrautsmlcnpetcnsmtr.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRAUTSMLCNPETCNSMTR }
     *     
     */
    public ResponseBansefi.OTRAUTSMLCNPETCNSMTR getOTRAUTSMLCNPETCNSMTR() {
        return otrautsmlcnpetcnsmtr;
    }

    /**
     * Define el valor de la propiedad otrautsmlcnpetcnsmtr.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRAUTSMLCNPETCNSMTR }
     *     
     */
    public void setOTRAUTSMLCNPETCNSMTR(ResponseBansefi.OTRAUTSMLCNPETCNSMTR value) {
        this.otrautsmlcnpetcnsmtr = value;
    }
    ...
    public static class OTRAUTSMLCNPETCNSMTR {
        ...
        protected List<ResponseBansefi.OTRAUTSMLCNPETCNSMTR.SMSOLCTDESGLSE> smsolctdesglse;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRAUTSMLCNPETCNSMTR.SMSOLCTDESGLSE }
         * 
         * 
         */
        public List<ResponseBansefi.OTRAUTSMLCNPETCNSMTR.SMSOLCTDESGLSE> getSMSOLCTDESGLSE() {
            if (smsolctdesglse == null) {
                smsolctdesglse = new ArrayList<ResponseBansefi.OTRAUTSMLCNPETCNSMTR.SMSOLCTDESGLSE>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRAUTSMLCNPETCNSMTR.STDTRNOPARMV value) {
