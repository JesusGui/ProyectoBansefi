 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_BAJA_PE_OTRO_NOMB">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_PE_BAJA_PE_OTRO_NOMB", required = true)
    protected ResponseBansefi.OTRPEBAJAPEOTRONOMB otrpebajapeotronomb;

    /**
     * Obtiene el valor de la propiedad otrpebajapeotronomb.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPEBAJAPEOTRONOMB }
     *     
     */
    public ResponseBansefi.OTRPEBAJAPEOTRONOMB getOTRPEBAJAPEOTRONOMB() {
        return otrpebajapeotronomb;
    }

    /**
     * Define el valor de la propiedad otrpebajapeotronomb.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPEBAJAPEOTRONOMB }
     *     
     */
    public void setOTRPEBAJAPEOTRONOMB(ResponseBansefi.OTRPEBAJAPEOTRONOMB value) {
        this.otrpebajapeotronomb = value;
    }
    ...
    public static class OTRPEBAJAPEOTRONOMB {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPEBAJAPEOTRONOMB.STDTRNOPARMV value) {
