 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_BAJA_COMPL_PROF_TR">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrpebajacomplproftr"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_PE_BAJA_COMPL_PROF_TR", required = true)
    protected ResponseBansefi.OTRPEBAJACOMPLPROFTR otrpebajacomplproftr;

    /**
     * Obtiene el valor de la propiedad otrpebajacomplproftr.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPEBAJACOMPLPROFTR }
     *     
     */
    public ResponseBansefi.OTRPEBAJACOMPLPROFTR getOTRPEBAJACOMPLPROFTR() {
        return otrpebajacomplproftr;
    }

    /**
     * Define el valor de la propiedad otrpebajacomplproftr.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPEBAJACOMPLPROFTR }
     *     
     */
    public void setOTRPEBAJACOMPLPROFTR(ResponseBansefi.OTRPEBAJACOMPLPROFTR value) {
        this.otrpebajacomplproftr = value;
    }
    ...
    public static class OTRPEBAJACOMPLPROFTR {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPEBAJACOMPLPROFTR.STDTRNOPARMV value) {
