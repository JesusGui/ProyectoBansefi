 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_MODI_INDV_REF_PER_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "opemodiindvrefpertrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OPE_MODI_INDV_REF_PER_TRN", required = true)
    protected ResponseBansefi.OPEMODIINDVREFPERTRN opemodiindvrefpertrn;

    /**
     * Obtiene el valor de la propiedad opemodiindvrefpertrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEMODIINDVREFPERTRN }
     *     
     */
    public ResponseBansefi.OPEMODIINDVREFPERTRN getOPEMODIINDVREFPERTRN() {
        return opemodiindvrefpertrn;
    }

    /**
     * Define el valor de la propiedad opemodiindvrefpertrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEMODIINDVREFPERTRN }
     *     
     */
    public void setOPEMODIINDVREFPERTRN(ResponseBansefi.OPEMODIINDVREFPERTRN value) {
        this.opemodiindvrefpertrn = value;
    }
    ...
    public static class OPEMODIINDVREFPERTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEMODIINDVREFPERTRN.STDTRNOPARMV value) {
