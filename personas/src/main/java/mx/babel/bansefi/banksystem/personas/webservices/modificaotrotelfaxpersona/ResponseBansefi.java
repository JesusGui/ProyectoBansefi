 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_DR_MODIF_DR_ELCTR_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrdrmodifdrelctrtrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_DR_MODIF_DR_ELCTR_TRN", required = true)
    protected ResponseBansefi.OTRDRMODIFDRELCTRTRN otrdrmodifdrelctrtrn;

    /**
     * Obtiene el valor de la propiedad otrdrmodifdrelctrtrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRDRMODIFDRELCTRTRN }
     *     
     */
    public ResponseBansefi.OTRDRMODIFDRELCTRTRN getOTRDRMODIFDRELCTRTRN() {
        return otrdrmodifdrelctrtrn;
    }

    /**
     * Define el valor de la propiedad otrdrmodifdrelctrtrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRDRMODIFDRELCTRTRN }
     *     
     */
    public void setOTRDRMODIFDRELCTRTRN(ResponseBansefi.OTRDRMODIFDRELCTRTRN value) {
        this.otrdrmodifdrelctrtrn = value;
    }
    ...
    public static class OTRDRMODIFDRELCTRTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRDRMODIFDRELCTRTRN.STDTRNOPARMV value) {
