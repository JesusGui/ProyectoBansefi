 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_BAJA_INDV_REF_PER_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "opebajaindvrefpertrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OPE_BAJA_INDV_REF_PER_TRN", required = true)
    protected ResponseBansefi.OPEBAJAINDVREFPERTRN opebajaindvrefpertrn;

    /**
     * Obtiene el valor de la propiedad opebajaindvrefpertrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEBAJAINDVREFPERTRN }
     *     
     */
    public ResponseBansefi.OPEBAJAINDVREFPERTRN getOPEBAJAINDVREFPERTRN() {
        return opebajaindvrefpertrn;
    }

    /**
     * Define el valor de la propiedad opebajaindvrefpertrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEBAJAINDVREFPERTRN }
     *     
     */
    public void setOPEBAJAINDVREFPERTRN(ResponseBansefi.OPEBAJAINDVREFPERTRN value) {
        this.opebajaindvrefpertrn = value;
    }
    ...
    public static class OPEBAJAINDVREFPERTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEBAJAINDVREFPERTRN.STDTRNOPARMV value) {
