 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_MODI_ORG_ACC_FUN_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OPE_MODI_ORG_ACC_FUN_TRN", required = true)
    protected ResponseBansefi.OPEMODIORGACCFUNTRN opemodiorgaccfuntrn;

    /**
     * Obtiene el valor de la propiedad opemodiorgaccfuntrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEMODIORGACCFUNTRN }
     *     
     */
    public ResponseBansefi.OPEMODIORGACCFUNTRN getOPEMODIORGACCFUNTRN() {
        return opemodiorgaccfuntrn;
    }

    /**
     * Define el valor de la propiedad opemodiorgaccfuntrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEMODIORGACCFUNTRN }
     *     
     */
    public void setOPEMODIORGACCFUNTRN(ResponseBansefi.OPEMODIORGACCFUNTRN value) {
        this.opemodiorgaccfuntrn = value;
    }
    ...
    public static class OPEMODIORGACCFUNTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEMODIORGACCFUNTRN.STDTRNOPARMV value) {
