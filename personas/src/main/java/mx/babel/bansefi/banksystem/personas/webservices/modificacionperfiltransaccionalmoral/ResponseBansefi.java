 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_MODI_ORG_PERF_TRAN_TR">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "opemodiorgperftrantr"
})
public class ResponseBansefi {

    @XmlElement(name = "OPE_MODI_ORG_PERF_TRAN_TR", required = true)
    protected ResponseBansefi.OPEMODIORGPERFTRANTR opemodiorgperftrantr;

    /**
     * Obtiene el valor de la propiedad opemodiorgperftrantr.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEMODIORGPERFTRANTR }
     *     
     */
    public ResponseBansefi.OPEMODIORGPERFTRANTR getOPEMODIORGPERFTRANTR() {
        return opemodiorgperftrantr;
    }

    /**
     * Define el valor de la propiedad opemodiorgperftrantr.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEMODIORGPERFTRANTR }
     *     
     */
    public void setOPEMODIORGPERFTRANTR(ResponseBansefi.OPEMODIORGPERFTRANTR value) {
        this.opemodiorgperftrantr = value;
    }
    ...
    public static class OPEMODIORGPERFTRANTR {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEMODIORGPERFTRANTR.STDTRNOPARMV value) {
