 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_BAJA_PE_ID_EXT_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_PE_BAJA_PE_ID_EXT_TRN", required = true)
    protected ResponseBansefi.OTRPEBAJAPEIDEXTTRN otrpebajapeidexttrn;

    /**
     * Obtiene el valor de la propiedad otrpebajapeidexttrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPEBAJAPEIDEXTTRN }
     *     
     */
    public ResponseBansefi.OTRPEBAJAPEIDEXTTRN getOTRPEBAJAPEIDEXTTRN() {
        return otrpebajapeidexttrn;
    }

    /**
     * Define el valor de la propiedad otrpebajapeidexttrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPEBAJAPEIDEXTTRN }
     *     
     */
    public void setOTRPEBAJAPEIDEXTTRN(ResponseBansefi.OTRPEBAJAPEIDEXTTRN value) {
        this.otrpebajapeidexttrn = value;
    }
    ...
    public static class OTRPEBAJAPEIDEXTTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_PE_BAJA_PE_ID_EXT_EVT", required = true)
        protected ResponseBansefi.OTRPEBAJAPEIDEXTTRN.TRPEBAJAPEIDEXTEVT trpebajapeidextevt;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEBAJAPEIDEXTTRN.TRPEBAJAPEIDEXTEVT }
         *     
         */
        public ResponseBansefi.OTRPEBAJAPEIDEXTTRN.TRPEBAJAPEIDEXTEVT getTRPEBAJAPEIDEXTEVT() {
         ...
         *     
         */
        public void setTRPEBAJAPEIDEXTEVT(ResponseBansefi.OTRPEBAJAPEIDEXTTRN.TRPEBAJAPEIDEXTEVT value) {
         ...
         * {@link ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPEBAJAPEIDEXTTRN.STDTRNOPARMV value) {
