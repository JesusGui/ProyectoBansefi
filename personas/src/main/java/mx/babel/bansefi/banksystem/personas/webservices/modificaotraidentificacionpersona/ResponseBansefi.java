 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_MODIF_PE_ID_EXT_TR">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_PE_MODIF_PE_ID_EXT_TR", required = true)
    protected ResponseBansefi.OTRPEMODIFPEIDEXTTR otrpemodifpeidexttr;

    /**
     * Obtiene el valor de la propiedad otrpemodifpeidexttr.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPEMODIFPEIDEXTTR }
     *     
     */
    public ResponseBansefi.OTRPEMODIFPEIDEXTTR getOTRPEMODIFPEIDEXTTR() {
        return otrpemodifpeidexttr;
    }

    /**
     * Define el valor de la propiedad otrpemodifpeidexttr.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPEMODIFPEIDEXTTR }
     *     
     */
    public void setOTRPEMODIFPEIDEXTTR(ResponseBansefi.OTRPEMODIFPEIDEXTTR value) {
        this.otrpemodifpeidexttr = value;
    }
    ...
    public static class OTRPEMODIFPEIDEXTTR {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_PE_MODIF_PE_ID_EXT_EVT", required = true)
        protected ResponseBansefi.OTRPEMODIFPEIDEXTTR.TRPEMODIFPEIDEXTEVT trpemodifpeidextevt;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEMODIFPEIDEXTTR.TRPEMODIFPEIDEXTEVT }
         *     
         */
        public ResponseBansefi.OTRPEMODIFPEIDEXTTR.TRPEMODIFPEIDEXTEVT getTRPEMODIFPEIDEXTEVT() {
         ...
         *     
         */
        public void setTRPEMODIFPEIDEXTEVT(ResponseBansefi.OTRPEMODIFPEIDEXTTR.TRPEMODIFPEIDEXTEVT value) {
         ...
         * {@link ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPEMODIFPEIDEXTTR.STDTRNOPARMV value) {
