 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_DR_RGSTRO_CNS_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_DR_RGSTRO_CNS_EVT_Z">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_DR_RGSTRO_CNS_TRN_O", required = true)
    protected ResponseBansefi.OTRDRRGSTROCNSTRNO otrdrrgstrocnstrno;

    /**
     * Obtiene el valor de la propiedad otrdrrgstrocnstrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRDRRGSTROCNSTRNO }
     *     
     */
    public ResponseBansefi.OTRDRRGSTROCNSTRNO getOTRDRRGSTROCNSTRNO() {
        return otrdrrgstrocnstrno;
    }

    /**
     * Define el valor de la propiedad otrdrrgstrocnstrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRDRRGSTROCNSTRNO }
     *     
     */
    public void setOTRDRRGSTROCNSTRNO(ResponseBansefi.OTRDRRGSTROCNSTRNO value) {
        this.otrdrrgstrocnstrno = value;
    }
    ...
    public static class OTRDRRGSTROCNSTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "NUMBER_OF_RECORDS")
        protected int numberofrecords;
        @XmlElement(name = "TR_DR_RGSTRO_CNS_EVT_Z", required = true)
        protected ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ trdrrgstrocnsevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trdrrgstrocnsevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ }
         *     
         */
        public ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ getTRDRRGSTROCNSEVTZ() {
            return trdrrgstrocnsevtz;
        }

        /**
         * Define el valor de la propiedad trdrrgstrocnsevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ }
         *     
         */
        public void setTRDRRGSTROCNSEVTZ(ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ value) {
            this.trdrrgstrocnsevtz = value;
        }
         ...
         * {@link ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRDRRGSTROCNSTRNO.STDTRNOPARMV value) {
        ...
        public static class TRDRRGSTROCNSEVTZ {
            ...
            protected List<ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ.DRCOMPRGSTROV> drcomprgstrov;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ.DRCOMPRGSTROV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ.DRCOMPRGSTROV> getDRCOMPRGSTROV() {
                if (drcomprgstrov == null) {
                    drcomprgstrov = new ArrayList<ResponseBansefi.OTRDRRGSTROCNSTRNO.TRDRRGSTROCNSEVTZ.DRCOMPRGSTROV>();
                }
