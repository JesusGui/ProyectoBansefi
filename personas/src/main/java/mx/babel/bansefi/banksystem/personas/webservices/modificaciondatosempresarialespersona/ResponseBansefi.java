 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_MODIF_COMPL_EMPR_T">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrpemodifcomplemprt"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_PE_MODIF_COMPL_EMPR_T", required = true)
    protected ResponseBansefi.OTRPEMODIFCOMPLEMPRT otrpemodifcomplemprt;

    /**
     * Obtiene el valor de la propiedad otrpemodifcomplemprt.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPEMODIFCOMPLEMPRT }
     *     
     */
    public ResponseBansefi.OTRPEMODIFCOMPLEMPRT getOTRPEMODIFCOMPLEMPRT() {
        return otrpemodifcomplemprt;
    }

    /**
     * Define el valor de la propiedad otrpemodifcomplemprt.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPEMODIFCOMPLEMPRT }
     *     
     */
    public void setOTRPEMODIFCOMPLEMPRT(ResponseBansefi.OTRPEMODIFCOMPLEMPRT value) {
        this.otrpemodifcomplemprt = value;
    }
    ...
    public static class OTRPEMODIFCOMPLEMPRT {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPEMODIFCOMPLEMPRT.STDTRNOPARMV value) {
