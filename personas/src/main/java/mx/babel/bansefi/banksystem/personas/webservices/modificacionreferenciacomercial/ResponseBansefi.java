 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_MODI_ORG_REF_COM_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OPE_MODI_ORG_REF_COM_TRN", required = true)
    protected ResponseBansefi.OPEMODIORGREFCOMTRN opemodiorgrefcomtrn;

    /**
     * Obtiene el valor de la propiedad opemodiorgrefcomtrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEMODIORGREFCOMTRN }
     *     
     */
    public ResponseBansefi.OPEMODIORGREFCOMTRN getOPEMODIORGREFCOMTRN() {
        return opemodiorgrefcomtrn;
    }

    /**
     * Define el valor de la propiedad opemodiorgrefcomtrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEMODIORGREFCOMTRN }
     *     
     */
    public void setOPEMODIORGREFCOMTRN(ResponseBansefi.OPEMODIORGREFCOMTRN value) {
        this.opemodiorgrefcomtrn = value;
    }
    ...
    public static class OPEMODIORGREFCOMTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEMODIORGREFCOMTRN.STDTRNOPARMV value) {
