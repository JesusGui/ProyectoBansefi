 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_MODIF_COMPL_PROF_T">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrpemodifcomplproft"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_PE_MODIF_COMPL_PROF_T", required = true)
    protected ResponseBansefi.OTRPEMODIFCOMPLPROFT otrpemodifcomplproft;

    /**
     * Obtiene el valor de la propiedad otrpemodifcomplproft.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPEMODIFCOMPLPROFT }
     *     
     */
    public ResponseBansefi.OTRPEMODIFCOMPLPROFT getOTRPEMODIFCOMPLPROFT() {
        return otrpemodifcomplproft;
    }

    /**
     * Define el valor de la propiedad otrpemodifcomplproft.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPEMODIFCOMPLPROFT }
     *     
     */
    public void setOTRPEMODIFCOMPLPROFT(ResponseBansefi.OTRPEMODIFCOMPLPROFT value) {
        this.otrpemodifcomplproft = value;
    }
    ...
    public static class OTRPEMODIFCOMPLPROFT {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPEMODIFCOMPLPROFT.STDTRNOPARMV value) {
