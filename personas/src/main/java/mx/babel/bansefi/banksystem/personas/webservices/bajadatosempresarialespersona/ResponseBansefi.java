 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_BAJA_COMPL_EMPR_TR">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrpebajacomplemprtr"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_PE_BAJA_COMPL_EMPR_TR", required = true)
    protected ResponseBansefi.OTRPEBAJACOMPLEMPRTR otrpebajacomplemprtr;

    /**
     * Obtiene el valor de la propiedad otrpebajacomplemprtr.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPEBAJACOMPLEMPRTR }
     *     
     */
    public ResponseBansefi.OTRPEBAJACOMPLEMPRTR getOTRPEBAJACOMPLEMPRTR() {
        return otrpebajacomplemprtr;
    }

    /**
     * Define el valor de la propiedad otrpebajacomplemprtr.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPEBAJACOMPLEMPRTR }
     *     
     */
    public void setOTRPEBAJACOMPLEMPRTR(ResponseBansefi.OTRPEBAJACOMPLEMPRTR value) {
        this.otrpebajacomplemprtr = value;
    }
    ...
    public static class OTRPEBAJACOMPLEMPRTR {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPEBAJACOMPLEMPRTR.STDTRNOPARMV value) {
