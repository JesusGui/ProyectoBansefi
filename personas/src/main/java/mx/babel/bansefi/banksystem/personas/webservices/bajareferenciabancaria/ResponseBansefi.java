 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_BAJA_ORG_REF_BAN_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OPE_BAJA_ORG_REF_BAN_TRN", required = true)
    protected ResponseBansefi.OPEBAJAORGREFBANTRN opebajaorgrefbantrn;

    /**
     * Obtiene el valor de la propiedad opebajaorgrefbantrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEBAJAORGREFBANTRN }
     *     
     */
    public ResponseBansefi.OPEBAJAORGREFBANTRN getOPEBAJAORGREFBANTRN() {
        return opebajaorgrefbantrn;
    }

    /**
     * Define el valor de la propiedad opebajaorgrefbantrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEBAJAORGREFBANTRN }
     *     
     */
    public void setOPEBAJAORGREFBANTRN(ResponseBansefi.OPEBAJAORGREFBANTRN value) {
        this.opebajaorgrefbantrn = value;
    }
    ...
    public static class OPEBAJAORGREFBANTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEBAJAORGREFBANTRN.STDTRNOPARMV value) {
