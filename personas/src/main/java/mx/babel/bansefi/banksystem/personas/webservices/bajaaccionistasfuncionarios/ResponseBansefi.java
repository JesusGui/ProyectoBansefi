 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_BAJA_ORG_ACC_FUN_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OPE_BAJA_ORG_ACC_FUN_TRN", required = true)
    protected ResponseBansefi.OPEBAJAORGACCFUNTRN opebajaorgaccfuntrn;

    /**
     * Obtiene el valor de la propiedad opebajaorgaccfuntrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEBAJAORGACCFUNTRN }
     *     
     */
    public ResponseBansefi.OPEBAJAORGACCFUNTRN getOPEBAJAORGACCFUNTRN() {
        return opebajaorgaccfuntrn;
    }

    /**
     * Define el valor de la propiedad opebajaorgaccfuntrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEBAJAORGACCFUNTRN }
     *     
     */
    public void setOPEBAJAORGACCFUNTRN(ResponseBansefi.OPEBAJAORGACCFUNTRN value) {
        this.opebajaorgaccfuntrn = value;
    }
    ...
    public static class OPEBAJAORGACCFUNTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEBAJAORGACCFUNTRN.STDTRNOPARMV value) {
