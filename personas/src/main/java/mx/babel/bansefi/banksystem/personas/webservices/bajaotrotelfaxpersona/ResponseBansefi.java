 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_DR_BAJA_DR_ELCTR_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_DR_BAJA_DR_ELCTR_TRN", required = true)
    protected ResponseBansefi.OTRDRBAJADRELCTRTRN otrdrbajadrelctrtrn;

    /**
     * Obtiene el valor de la propiedad otrdrbajadrelctrtrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRDRBAJADRELCTRTRN }
     *     
     */
    public ResponseBansefi.OTRDRBAJADRELCTRTRN getOTRDRBAJADRELCTRTRN() {
        return otrdrbajadrelctrtrn;
    }

    /**
     * Define el valor de la propiedad otrdrbajadrelctrtrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRDRBAJADRELCTRTRN }
     *     
     */
    public void setOTRDRBAJADRELCTRTRN(ResponseBansefi.OTRDRBAJADRELCTRTRN value) {
        this.otrdrbajadrelctrtrn = value;
    }
    ...
    public static class OTRDRBAJADRELCTRTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRDRBAJADRELCTRTRN.STDTRNOPARMV value) {
