...
public class ResponseBansefi {
    ...
    @XmlElement(name = "TR_GR_LST_TRN_O", required = true)
    protected ResponseBansefi.TRGRLSTTRNO trgrlsttrno;

    /**
     * Obtiene el valor de la propiedad trgrlsttrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.TRGRLSTTRNO }
     *     
     */
    public ResponseBansefi.TRGRLSTTRNO getTRGRLSTTRNO() {
        return trgrlsttrno;
    }

    /**
     * Define el valor de la propiedad trgrlsttrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.TRGRLSTTRNO }
     *     
     */
    public void setTRGRLSTTRNO(ResponseBansefi.TRGRLSTTRNO value) {
        this.trgrlsttrno = value;
    }
    ...
    public static class TRGRLSTTRNO {
        ...
        protected ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ trgrlstevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.TRGRLSTTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.TRGRLSTTRNO.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ }
         *     
         */
        public ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ getTRGRLSTEVTZ() {
            return trgrlstevtz;
        }
         ...
         *     
         */
        public void setTRGRLSTEVTZ(ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ value) {
         ...
         * {@link ResponseBansefi.TRGRLSTTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.TRGRLSTTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.TRGRLSTTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.TRGRLSTTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.TRGRLSTTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.TRGRLSTTRNO.STDTRNOPARMV value) {
        ...
        public static class TRGRLSTEVTZ {
            ...
            protected List<ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV> trgrlstevtv;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV }
             * 
             * 
             */
            public List<ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV> getTRGRLSTEVTV() {
                if (trgrlstevtv == null) {
                    trgrlstevtv = new ArrayList<ResponseBansefi.TRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV>();
                }
