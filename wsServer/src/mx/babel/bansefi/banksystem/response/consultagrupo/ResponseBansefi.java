...
public class ResponseBansefi {
    ...
    @XmlElement(name = "TR_GR_CONS_TRN_O", required = true)
    protected ResponseBansefi.TRGRCONSTRNO trgrconstrno;

    /**
     * Obtiene el valor de la propiedad trgrconstrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.TRGRCONSTRNO }
     *     
     */
    public ResponseBansefi.TRGRCONSTRNO getTRGRCONSTRNO() {
        return trgrconstrno;
    }

    /**
     * Define el valor de la propiedad trgrconstrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.TRGRCONSTRNO }
     *     
     */
    public void setTRGRCONSTRNO(ResponseBansefi.TRGRCONSTRNO value) {
        this.trgrconstrno = value;
    }
    ...
    public static class TRGRCONSTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_GR_CONS_EVT_Z", required = true)
        protected ResponseBansefi.TRGRCONSTRNO.TRGRCONSEVTZ trgrconsevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.TRGRCONSTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.TRGRCONSTRNO.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trgrconsevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.TRGRCONSTRNO.TRGRCONSEVTZ }
         *     
         */
        public ResponseBansefi.TRGRCONSTRNO.TRGRCONSEVTZ getTRGRCONSEVTZ() {
            return trgrconsevtz;
        }

        /**
         * Define el valor de la propiedad trgrconsevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.TRGRCONSTRNO.TRGRCONSEVTZ }
         *     
         */
        public void setTRGRCONSEVTZ(ResponseBansefi.TRGRCONSTRNO.TRGRCONSEVTZ value) {
            this.trgrconsevtz = value;
        }
         ...
         * {@link ResponseBansefi.TRGRCONSTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.TRGRCONSTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.TRGRCONSTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.TRGRCONSTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.TRGRCONSTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.TRGRCONSTRNO.STDTRNOPARMV value) {
        ...
        public static class TRGRCONSEVTZ {
