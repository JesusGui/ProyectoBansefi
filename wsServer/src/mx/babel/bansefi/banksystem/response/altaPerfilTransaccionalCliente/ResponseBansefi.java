 ...
 *       &lt;sequence>
 *         &lt;element name="PE_ALTA_INDV_PERF_TRAN_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "pealtaindvperftrantrno"
})
public class ResponseBansefi {

    @XmlElement(name = "PE_ALTA_INDV_PERF_TRAN_TRN_O", required = true)
    protected ResponseBansefi.PEALTAINDVPERFTRANTRNO pealtaindvperftrantrno;

    /**
     * Obtiene el valor de la propiedad pealtaindvperftrantrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.PEALTAINDVPERFTRANTRNO }
     *     
     */
    public ResponseBansefi.PEALTAINDVPERFTRANTRNO getPEALTAINDVPERFTRANTRNO() {
        return pealtaindvperftrantrno;
    }

    /**
     * Define el valor de la propiedad pealtaindvperftrantrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.PEALTAINDVPERFTRANTRNO }
     *     
     */
    public void setPEALTAINDVPERFTRANTRNO(ResponseBansefi.PEALTAINDVPERFTRANTRNO value) {
        this.pealtaindvperftrantrno = value;
    }
    ...
    public static class PEALTAINDVPERFTRANTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.PEALTAINDVPERFTRANTRNO.STDTRNOPARMV value) {
