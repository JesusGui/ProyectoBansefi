 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_ANULACION_APLCCN_RV_T">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otranulacionaplccnrvt"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_ANULACION_APLCCN_RV_T", required = true)
    protected ResponseBansefi.OTRANULACIONAPLCCNRVT otranulacionaplccnrvt;

    /**
     * Obtiene el valor de la propiedad otranulacionaplccnrvt.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRANULACIONAPLCCNRVT }
     *     
     */
    public ResponseBansefi.OTRANULACIONAPLCCNRVT getOTRANULACIONAPLCCNRVT() {
        return otranulacionaplccnrvt;
    }

    /**
     * Define el valor de la propiedad otranulacionaplccnrvt.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRANULACIONAPLCCNRVT }
     *     
     */
    public void setOTRANULACIONAPLCCNRVT(ResponseBansefi.OTRANULACIONAPLCCNRVT value) {
        this.otranulacionaplccnrvt = value;
    }
    ...
    public static class OTRANULACIONAPLCCNRVT {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_AUTORIZA_V", required = true)
        protected ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV stdautorizav;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNOPARMV stdtrnoparmv;
        @XmlElement(name = "PSV_ERROR_V", required = true)
        protected List<ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVERRORV> psverrorv;
        @XmlElement(name = "PSV_IMP_AUT_V", required = true)
        protected ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVIMPAUTV psvimpautv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV }
         *     
         */
        public ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV getSTDAUTORIZAV() {
            return stdautorizav;
        }
         ...
         *     
         */
        public void setSTDAUTORIZAV(ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV value) {
         ...
         * {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRANULACIONAPLCCNRVT.STDTRNOPARMV value) {
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVERRORV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVERRORV> getPSVERRORV() {
            if (psverrorv == null) {
                psverrorv = new ArrayList<ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVERRORV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVIMPAUTV }
         *     
         */
        public ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVIMPAUTV getPSVIMPAUTV() {
            return psvimpautv;
        }
         ...
         *     
         */
        public void setPSVIMPAUTV(ResponseBansefi.OTRANULACIONAPLCCNRVT.PSVIMPAUTV value) {
        ...
        public static class STDAUTORIZAV {
            ...
            protected ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARAUTREMOTAP arautremotap;
            @XmlElement(name = "AR_TRN_MSJ_PARM_V", required = true)
            protected List<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARTRNMSJPARMV> artrnmsjparmv;
            @XmlElement(name = "STD_TARGET_TERMINAL_V", required = true)
            protected List<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.STDTARGETTERMINALV> stdtargetterminalv;
            @XmlElement(name = "AR_ID_SALTADO_V", required = true)
            protected ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARIDSALTADOV aridsaltadov;
             ...
             * @return
             *     possible object is
             *     {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARAUTREMOTAP }
             *     
             */
            public ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARAUTREMOTAP getARAUTREMOTAP() {
                return arautremotap;
            }
             ...
             *     
             */
            public void setARAUTREMOTAP(ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARAUTREMOTAP value) {
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARTRNMSJPARMV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARTRNMSJPARMV> getARTRNMSJPARMV() {
                if (artrnmsjparmv == null) {
                    artrnmsjparmv = new ArrayList<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARTRNMSJPARMV>();
                }
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.STDTARGETTERMINALV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.STDTARGETTERMINALV> getSTDTARGETTERMINALV() {
                if (stdtargetterminalv == null) {
                    stdtargetterminalv = new ArrayList<ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.STDTARGETTERMINALV>();
                }
             ...
             * @return
             *     possible object is
             *     {@link ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARIDSALTADOV }
             *     
             */
            public ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARIDSALTADOV getARIDSALTADOV() {
                return aridsaltadov;
            }
             ...
             *     
             */
            public void setARIDSALTADOV(ResponseBansefi.OTRANULACIONAPLCCNRVT.STDAUTORIZAV.ARIDSALTADOV value) {
