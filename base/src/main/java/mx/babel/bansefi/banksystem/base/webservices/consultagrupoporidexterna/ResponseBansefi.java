 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_GR_LST_EVT_Z">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="TR_GR_LST_EVT_V" maxOccurs="50">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_GR_LST_TRN_O", required = true)
    protected ResponseBansefi.OTRGRLSTTRNO otrgrlsttrno;

    /**
     * Obtiene el valor de la propiedad otrgrlsttrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRGRLSTTRNO }
     *     
     */
    public ResponseBansefi.OTRGRLSTTRNO getOTRGRLSTTRNO() {
        return otrgrlsttrno;
    }

    /**
     * Define el valor de la propiedad otrgrlsttrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRGRLSTTRNO }
     *     
     */
    public void setOTRGRLSTTRNO(ResponseBansefi.OTRGRLSTTRNO value) {
        this.otrgrlsttrno = value;
    }
    ...
    public static class OTRGRLSTTRNO {
        ...
        @XmlElement(name = "TR_GR_LST_EVT_Z", required = true)
        protected ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ trgrlstevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRGRLSTTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRGRLSTTRNO.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trgrlstevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ }
         *     
         */
        public ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ getTRGRLSTEVTZ() {
            return trgrlstevtz;
        }

        /**
         * Define el valor de la propiedad trgrlstevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ }
         *     
         */
        public void setTRGRLSTEVTZ(ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ value) {
            this.trgrlstevtz = value;
        }
         ...
         * {@link ResponseBansefi.OTRGRLSTTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRGRLSTTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRGRLSTTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRGRLSTTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRGRLSTTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRGRLSTTRNO.STDTRNOPARMV value) {
        ...
        public static class TRGRLSTEVTZ {

            @XmlElement(name = "TR_GR_LST_EVT_V", required = true)
            protected List<ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV> trgrlstevtv;

            /**
             * Gets the value of the trgrlstevtv property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the trgrlstevtv property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getTRGRLSTEVTV().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV> getTRGRLSTEVTV() {
                if (trgrlstevtv == null) {
                    trgrlstevtv = new ArrayList<ResponseBansefi.OTRGRLSTTRNO.TRGRLSTEVTZ.TRGRLSTEVTV>();
                }
                return this.trgrlstevtv;
            }
            ...
            public static class TRGRLSTEVTV {
                ...
                @XmlElement(name = "RZN_ALTA_GR", required = true)
                protected String rznaltagr;
                @XmlElement(name = "COD_ECV_GR", required = true)
                protected String codecvgr;
                @XmlElement(name = "FECHA_INIC_ECV")
                protected int fechainicecv;
                @XmlElement(name = "FECHA_ALTA_GR")
                protected int fechaaltagr;
                @XmlElement(name = "FECHA_BAJA_GR")
                protected int fechabajagr;
                @XmlElement(name = "RZN_BAJA_GR", required = true)
                protected String rznbajagr;
                ...
                /**
                 * Obtiene el valor de la propiedad rznaltagr.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                 *     
                 */
                public String getRZNALTAGR() {
                    return rznaltagr;
                }

                /**
                 * Define el valor de la propiedad rznaltagr.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setRZNALTAGR(String value) {
                    this.rznaltagr = value;
                }

                /**
                 * Obtiene el valor de la propiedad codecvgr.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                 *     
                 */
                public String getCODECVGR() {
                    return codecvgr;
                }

                /**
                 * Define el valor de la propiedad codecvgr.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setCODECVGR(String value) {
                    this.codecvgr = value;
                }
                ...
                /**
                 * Obtiene el valor de la propiedad fechaaltagr.
                 * 
                 */
                public int getFECHAALTAGR() {
                    return fechaaltagr;
                }

                /**
                 * Define el valor de la propiedad fechaaltagr.
                 * 
                 */
                public void setFECHAALTAGR(int value) {
                    this.fechaaltagr = value;
                }

                /**
                 * Obtiene el valor de la propiedad fechabajagr.
                 * 
                 */
                public int getFECHABAJAGR() {
                    return fechabajagr;
                }

                /**
                 * Define el valor de la propiedad fechabajagr.
                 * 
                 */
                public void setFECHABAJAGR(int value) {
                    this.fechabajagr = value;
                }

                /**
                 * Obtiene el valor de la propiedad rznbajagr.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                 *     
                 */
                public String getRZNBAJAGR() {
                    return rznbajagr;
                }

                /**
                 * Define el valor de la propiedad rznbajagr.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setRZNBAJAGR(String value) {
                    this.rznbajagr = value;
                }
