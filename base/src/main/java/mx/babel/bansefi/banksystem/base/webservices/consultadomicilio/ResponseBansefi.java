 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_CONS_DOMIC_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_PE_CONS_DOMIC_TRN_O", required = true)
    protected ResponseBansefi.OTRPECONSDOMICTRNO otrpeconsdomictrno;

    /**
     * Obtiene el valor de la propiedad otrpeconsdomictrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPECONSDOMICTRNO }
     *     
     */
    public ResponseBansefi.OTRPECONSDOMICTRNO getOTRPECONSDOMICTRNO() {
        return otrpeconsdomictrno;
    }

    /**
     * Define el valor de la propiedad otrpeconsdomictrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPECONSDOMICTRNO }
     *     
     */
    public void setOTRPECONSDOMICTRNO(ResponseBansefi.OTRPECONSDOMICTRNO value) {
        this.otrpeconsdomictrno = value;
    }
    ...
    public static class OTRPECONSDOMICTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_PE_CONS_DOMIC_EVT_Z", required = true)
        protected ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ trpeconsdomicevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ }
         *     
         */
        public ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ getTRPECONSDOMICEVTZ() {
         ...
         *     
         */
        public void setTRPECONSDOMICEVTZ(ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ value) {
         ...
         * {@link ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPECONSDOMICTRNO.STDTRNOPARMV value) {
        ...
        public static class TRPECONSDOMICEVTZ {
            ...
            protected List<ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.COMPDOMICV> compdomicv;
            @XmlElement(name = "COD_PERS_RL_DIR_V", required = true)
            protected List<ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.CODPERSRLDIRV> codpersrldirv;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.COMPDOMICV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.COMPDOMICV> getCOMPDOMICV() {
                if (compdomicv == null) {
                    compdomicv = new ArrayList<ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.COMPDOMICV>();
                }
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.CODPERSRLDIRV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.CODPERSRLDIRV> getCODPERSRLDIRV() {
                if (codpersrldirv == null) {
                    codpersrldirv = new ArrayList<ResponseBansefi.OTRPECONSDOMICTRNO.TRPECONSDOMICEVTZ.CODPERSRLDIRV>();
                }
