...
package mx.babel.bansefi.banksystem.base.webservices.busquedanombre;
 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_PE_CB_NOMBRE_CNS_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_PE_CB_NOMBRE_CNS_EVT_Z">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="TR_PE_CB_NOMBRE_CNS_EVT_V" maxOccurs="50">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_PE_CB_NOMBRE_CNS_TRN", required = true)
    protected ResponseBansefi.OTRPECBNOMBRECNSTRN otrpecbnombrecnstrn;

    /**
     * Obtiene el valor de la propiedad otrpecbnombrecnstrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRPECBNOMBRECNSTRN }
     *     
     */
    public ResponseBansefi.OTRPECBNOMBRECNSTRN getOTRPECBNOMBRECNSTRN() {
        return otrpecbnombrecnstrn;
    }

    /**
     * Define el valor de la propiedad otrpecbnombrecnstrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRPECBNOMBRECNSTRN }
     *     
     */
    public void setOTRPECBNOMBRECNSTRN(ResponseBansefi.OTRPECBNOMBRECNSTRN value) {
        this.otrpecbnombrecnstrn = value;
    }
    ...
    public static class OTRPECBNOMBRECNSTRN {
        ...
        @XmlElement(name = "TR_PE_CB_NOMBRE_CNS_EVT_Z", required = true)
        protected ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ trpecbnombrecnsevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trpecbnombrecnsevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ }
         *     
         */
        public ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ getTRPECBNOMBRECNSEVTZ() {
            return trpecbnombrecnsevtz;
        }

        /**
         * Define el valor de la propiedad trpecbnombrecnsevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ }
         *     
         */
        public void setTRPECBNOMBRECNSEVTZ(ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ value) {
            this.trpecbnombrecnsevtz = value;
        }
         ...
         * {@link ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRPECBNOMBRECNSTRN.STDTRNOPARMV value) {
        ...
        public static class TRPECBNOMBRECNSEVTZ {

            @XmlElement(name = "TR_PE_CB_NOMBRE_CNS_EVT_V", required = true)
            protected List<ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ.TRPECBNOMBRECNSEVTV> trpecbnombrecnsevtv;

            /**
             * Gets the value of the trpecbnombrecnsevtv property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the trpecbnombrecnsevtv property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getTRPECBNOMBRECNSEVTV().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ.TRPECBNOMBRECNSEVTV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ.TRPECBNOMBRECNSEVTV> getTRPECBNOMBRECNSEVTV() {
                if (trpecbnombrecnsevtv == null) {
                    trpecbnombrecnsevtv = new ArrayList<ResponseBansefi.OTRPECBNOMBRECNSTRN.TRPECBNOMBRECNSEVTZ.TRPECBNOMBRECNSEVTV>();
                }
                return this.trpecbnombrecnsevtv;
            }
            ...
            public static class TRPECBNOMBRECNSEVTV {
                ...
                @XmlElement(name = "VAL_OTRS_NOMB_PE", required = true)
                protected String valotrsnombpe;
                @XmlElement(name = "APE2_C", required = true)
                protected String ape2C;
                @XmlElement(name = "NOMB_C", required = true)
                protected String nombc;
                @XmlElement(name = "DENOM_LEGAL_OR_C", required = true)
                protected String denomlegalorc;
                ...
                /**
                 * Obtiene el valor de la propiedad valotrsnombpe.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                 *     
                 */
                public String getVALOTRSNOMBPE() {
                    return valotrsnombpe;
                }

                /**
                 * Define el valor de la propiedad valotrsnombpe.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setVALOTRSNOMBPE(String value) {
                    this.valotrsnombpe = value;
                }

                /**
                 * Obtiene el valor de la propiedad ape2C.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                ...
                /**
                 * Define el valor de la propiedad ape2C.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setAPE2C(String value) {
                    this.ape2C = value;
                }

                /**
                 * Obtiene el valor de la propiedad nombc.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                ...
                /**
                 * Define el valor de la propiedad nombc.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setNOMBC(String value) {
                    this.nombc = value;
                }

                /**
                 * Obtiene el valor de la propiedad denomlegalorc.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                 *     
                 */
                public String getDENOMLEGALORC() {
                    return denomlegalorc;
                }

                /**
                 * Define el valor de la propiedad denomlegalorc.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setDENOMLEGALORC(String value) {
                    this.denomlegalorc = value;
                }
