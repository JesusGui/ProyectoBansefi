 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_CRCT_LST_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_CRCT_LST_EVT_Z">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="TR_CRCT_LST_EVT_V" maxOccurs="50">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_CRCT_LST_TRN_O", required = true)
    protected ResponseBansefi.OTRCRCTLSTTRNO otrcrctlsttrno;

    /**
     * Obtiene el valor de la propiedad otrcrctlsttrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRCRCTLSTTRNO }
     *     
     */
    public ResponseBansefi.OTRCRCTLSTTRNO getOTRCRCTLSTTRNO() {
        return otrcrctlsttrno;
    }

    /**
     * Define el valor de la propiedad otrcrctlsttrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRCRCTLSTTRNO }
     *     
     */
    public void setOTRCRCTLSTTRNO(ResponseBansefi.OTRCRCTLSTTRNO value) {
        this.otrcrctlsttrno = value;
    }
    ...
    public static class OTRCRCTLSTTRNO {
        ...
        @XmlElement(name = "TR_CRCT_LST_EVT_Z", required = true)
        protected ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ trcrctlstevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRCRCTLSTTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRCRCTLSTTRNO.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trcrctlstevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ }
         *     
         */
        public ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ getTRCRCTLSTEVTZ() {
            return trcrctlstevtz;
        }

        /**
         * Define el valor de la propiedad trcrctlstevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ }
         *     
         */
        public void setTRCRCTLSTEVTZ(ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ value) {
            this.trcrctlstevtz = value;
        }
         ...
         * {@link ResponseBansefi.OTRCRCTLSTTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRCRCTLSTTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRCRCTLSTTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRCRCTLSTTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRCRCTLSTTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRCRCTLSTTRNO.STDTRNOPARMV value) {
        ...
        public static class TRCRCTLSTEVTZ {

            @XmlElement(name = "TR_CRCT_LST_EVT_V", required = true)
            protected List<ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ.TRCRCTLSTEVTV> trcrctlstevtv;

            /**
             * Gets the value of the trcrctlstevtv property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the trcrctlstevtv property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getTRCRCTLSTEVTV().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ.TRCRCTLSTEVTV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ.TRCRCTLSTEVTV> getTRCRCTLSTEVTV() {
                if (trcrctlstevtv == null) {
                    trcrctlstevtv = new ArrayList<ResponseBansefi.OTRCRCTLSTTRNO.TRCRCTLSTEVTZ.TRCRCTLSTEVTV>();
                }
                return this.trcrctlstevtv;
            }
            ...
            public static class TRCRCTLSTEVTV {
