...
public class ArrayToIntegerConverter extends DozerConverter<ArrayList, Integer>
        implements MapperAware {

    public ArrayToIntegerConverter() {
        super(ArrayList.class, Integer.class);
    ...
    @Override
    public Integer convertTo(ArrayList source, Integer destination) {
            ...
            try {
                ...
                if (atributos[0].equals(codigo)) {
                    if(StringUtils.isNoneBlank((String) metodo2.invoke(objeto))){
                        return Integer.valueOf(StringUtils.trim((String) metodo2.invoke(objeto)));
                    }else{
                        return null;
                    }
                }
    ...
    @Override
    public ArrayList convertFrom(Integer source, ArrayList destination) {
