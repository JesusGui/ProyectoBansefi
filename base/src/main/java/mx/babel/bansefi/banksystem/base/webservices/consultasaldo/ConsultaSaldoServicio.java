...
public class ConsultaSaldoServicio extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.200.14.125:3094/TRANSACCION/BANSEFI/VTCONSAL/WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ConsultaSaldoServicio.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://10.200.14.125:3094/TRANSACCION/BANSEFI/VTCONSAL/WSDL");
        }
        WSDL_LOCATION = url;
    }
