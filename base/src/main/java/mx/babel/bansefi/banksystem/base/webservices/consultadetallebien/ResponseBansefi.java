 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_BIEN_CNS_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_BIEN_CNS_EVT_Z">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_BIEN_CNS_TRN_O", required = true)
    protected ResponseBansefi.OTRBIENCNSTRNO otrbiencnstrno;

    /**
     * Obtiene el valor de la propiedad otrbiencnstrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRBIENCNSTRNO }
     *     
     */
    public ResponseBansefi.OTRBIENCNSTRNO getOTRBIENCNSTRNO() {
        return otrbiencnstrno;
    }

    /**
     * Define el valor de la propiedad otrbiencnstrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRBIENCNSTRNO }
     *     
     */
    public void setOTRBIENCNSTRNO(ResponseBansefi.OTRBIENCNSTRNO value) {
        this.otrbiencnstrno = value;
    }
    ...
    public static class OTRBIENCNSTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_BIEN_CNS_EVT_Z", required = true)
        protected ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ trbiencnsevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRBIENCNSTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRBIENCNSTRNO.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trbiencnsevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ }
         *     
         */
        public ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ getTRBIENCNSEVTZ() {
            return trbiencnsevtz;
        }

        /**
         * Define el valor de la propiedad trbiencnsevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ }
         *     
         */
        public void setTRBIENCNSEVTZ(ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ value) {
            this.trbiencnsevtz = value;
        }
         ...
         * {@link ResponseBansefi.OTRBIENCNSTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRBIENCNSTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRBIENCNSTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRBIENCNSTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRBIENCNSTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRBIENCNSTRNO.STDTRNOPARMV value) {
        ...
        public static class TRBIENCNSEVTZ {

            @XmlElement(name = "DATOS_BIEN_V", required = true)
            protected ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSBIENV datosbienv;
            @XmlElement(name = "DR_COMP_RGSTRO_V", required = true)
            protected List<ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DRCOMPRGSTROV> drcomprgstrov;
            @XmlElement(name = "DATOS_CARACT_V", required = true)
            protected List<ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSCARACTV> datoscaractv;
             ...
             * @return
             *     possible object is
             *     {@link ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSBIENV }
             *     
             */
            public ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSBIENV getDATOSBIENV() {
                return datosbienv;
            }
             ...
             *     
             */
            public void setDATOSBIENV(ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSBIENV value) {
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DRCOMPRGSTROV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DRCOMPRGSTROV> getDRCOMPRGSTROV() {
                if (drcomprgstrov == null) {
                    drcomprgstrov = new ArrayList<ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DRCOMPRGSTROV>();
                }
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSCARACTV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSCARACTV> getDATOSCARACTV() {
                if (datoscaractv == null) {
                    datoscaractv = new ArrayList<ResponseBansefi.OTRBIENCNSTRNO.TRBIENCNSEVTZ.DATOSCARACTV>();
                }
