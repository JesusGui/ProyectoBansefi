 ...
 *         &lt;element name="ITR_CRCT_LST_TRN_I">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_CRCT_LST_EVT_Y">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
...
public class Ejecutar {
    ...
    @XmlElement(name = "ITR_CRCT_LST_TRN_I", required = true)
    protected Ejecutar.ITRCRCTLSTTRNI itrcrctlsttrni;
    ...
    /**
     * Obtiene el valor de la propiedad itrcrctlsttrni.
     * 
     * @return
     *     possible object is
     *     {@link Ejecutar.ITRCRCTLSTTRNI }
     *     
     */
    public Ejecutar.ITRCRCTLSTTRNI getITRCRCTLSTTRNI() {
        return itrcrctlsttrni;
    }

    /**
     * Define el valor de la propiedad itrcrctlsttrni.
     * 
     * @param value
     *     allowed object is
     *     {@link Ejecutar.ITRCRCTLSTTRNI }
     *     
     */
    public void setITRCRCTLSTTRNI(Ejecutar.ITRCRCTLSTTRNI value) {
        this.itrcrctlsttrni = value;
    }
    ...
    public static class ITRCRCTLSTTRNI {
        ...
        @XmlElement(name = "TR_CRCT_LST_EVT_Y", required = true)
        protected Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY trcrctlstevty;
        @XmlElement(name = "STD_TRN_I_PARM_V", required = true)
        protected Ejecutar.ITRCRCTLSTTRNI.STDTRNIPARMV stdtrniparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trcrctlstevty.
         * 
         * @return
         *     possible object is
         *     {@link Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY }
         *     
         */
        public Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY getTRCRCTLSTEVTY() {
            return trcrctlstevty;
        }

        /**
         * Define el valor de la propiedad trcrctlstevty.
         * 
         * @param value
         *     allowed object is
         *     {@link Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY }
         *     
         */
        public void setTRCRCTLSTEVTY(Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY value) {
            this.trcrctlstevty = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Ejecutar.ITRCRCTLSTTRNI.STDTRNIPARMV }
         *     
         */
        public Ejecutar.ITRCRCTLSTTRNI.STDTRNIPARMV getSTDTRNIPARMV() {
            return stdtrniparmv;
        }
         ...
         *     
         */
        public void setSTDTRNIPARMV(Ejecutar.ITRCRCTLSTTRNI.STDTRNIPARMV value) {
        ...
        public static class TRCRCTLSTEVTY {

            @XmlElement(name = "BI_CRCT_BIEN_P", required = true)
            protected List<Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BICRCTBIENP> bicrctbienp;
            @XmlElement(name = "BI_VALOR_BIEN_P", required = true)
            protected Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BIVALORBIENP bivalorbienp;
             ...
             * {@link Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BICRCTBIENP }
             * 
             * 
             */
            public List<Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BICRCTBIENP> getBICRCTBIENP() {
                if (bicrctbienp == null) {
                    bicrctbienp = new ArrayList<Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BICRCTBIENP>();
                }
             ...
             * @return
             *     possible object is
             *     {@link Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BIVALORBIENP }
             *     
             */
            public Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BIVALORBIENP getBIVALORBIENP() {
                return bivalorbienp;
            }
             ...
             *     
             */
            public void setBIVALORBIENP(Ejecutar.ITRCRCTLSTTRNI.TRCRCTLSTEVTY.BIVALORBIENP value) {
