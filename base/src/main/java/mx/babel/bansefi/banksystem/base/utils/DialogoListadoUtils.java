 ...
 *
 */
public class DialogoListadoUtils implements Serializable{
	...
	public DialogoListadoUtils(Integer elementos){
	...
	private static String mensajeFalla(){
    	return "Algunas de las transacciones fallaron y es posible que haya perdido información. "
				+ "Por favor revise que todos los cambios se hayan realizado correctamente.";
    }
