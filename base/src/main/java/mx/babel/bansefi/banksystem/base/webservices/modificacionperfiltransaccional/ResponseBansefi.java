...
package mx.babel.bansefi.banksystem.base.webservices.modificacionperfiltransaccional;
 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_MODI_INDV_PERF_TRAN_T">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "opemodiindvperftrant"
})
public class ResponseBansefi {

    @XmlElement(name = "OPE_MODI_INDV_PERF_TRAN_T", required = true)
    protected ResponseBansefi.OPEMODIINDVPERFTRANT opemodiindvperftrant;

    /**
     * Obtiene el valor de la propiedad opemodiindvperftrant.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEMODIINDVPERFTRANT }
     *     
     */
    public ResponseBansefi.OPEMODIINDVPERFTRANT getOPEMODIINDVPERFTRANT() {
        return opemodiindvperftrant;
    }

    /**
     * Define el valor de la propiedad opemodiindvperftrant.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEMODIINDVPERFTRANT }
     *     
     */
    public void setOPEMODIINDVPERFTRANT(ResponseBansefi.OPEMODIINDVPERFTRANT value) {
        this.opemodiindvperftrant = value;
    }
    ...
    public static class OPEMODIINDVPERFTRANT {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEMODIINDVPERFTRANT.STDTRNOPARMV value) {
