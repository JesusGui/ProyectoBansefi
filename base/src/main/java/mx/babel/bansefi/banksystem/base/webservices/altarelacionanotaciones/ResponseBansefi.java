 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_ALTA_AN_COMP_PANT_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otraltaancomppanttrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_ALTA_AN_COMP_PANT_TRN", required = true)
    protected ResponseBansefi.OTRALTAANCOMPPANTTRN otraltaancomppanttrn;

    /**
     * Obtiene el valor de la propiedad otraltaancomppanttrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRALTAANCOMPPANTTRN }
     *     
     */
    public ResponseBansefi.OTRALTAANCOMPPANTTRN getOTRALTAANCOMPPANTTRN() {
        return otraltaancomppanttrn;
    }

    /**
     * Define el valor de la propiedad otraltaancomppanttrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRALTAANCOMPPANTTRN }
     *     
     */
    public void setOTRALTAANCOMPPANTTRN(ResponseBansefi.OTRALTAANCOMPPANTTRN value) {
        this.otraltaancomppanttrn = value;
    }
    ...
    public static class OTRALTAANCOMPPANTTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "AN_ANTCN_P", required = true)
        protected ResponseBansefi.OTRALTAANCOMPPANTTRN.ANANTCNP anantcnp;
        @XmlElement(name = "AN_NUM_ANTCN_V", required = true)
        protected ResponseBansefi.OTRALTAANCOMPPANTTRN.ANNUMANTCNV annumantcnv;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRALTAANCOMPPANTTRN.ANANTCNP }
         *     
         */
        public ResponseBansefi.OTRALTAANCOMPPANTTRN.ANANTCNP getANANTCNP() {
            return anantcnp;
        }
         ...
         *     
         */
        public void setANANTCNP(ResponseBansefi.OTRALTAANCOMPPANTTRN.ANANTCNP value) {
            this.anantcnp = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRALTAANCOMPPANTTRN.ANNUMANTCNV }
         *     
         */
        public ResponseBansefi.OTRALTAANCOMPPANTTRN.ANNUMANTCNV getANNUMANTCNV() {
            return annumantcnv;
        }
         ...
         *     
         */
        public void setANNUMANTCNV(ResponseBansefi.OTRALTAANCOMPPANTTRN.ANNUMANTCNV value) {
         ...
         * {@link ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRALTAANCOMPPANTTRN.STDTRNOPARMV value) {
