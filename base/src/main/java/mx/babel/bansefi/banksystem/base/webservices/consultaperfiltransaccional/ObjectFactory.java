 ...
 * generated in the mx.babel.bansefi.banksystem.base.webservices.consultaperfiltransaccional package. 
...
public class ObjectFactory {
    ...
    private final static QName EJECUTAR_RESULT_QNAME = new QName(mx.babel.arq.comun.constants.ServicioWebConstants.SOAP_PORT_URL_TRN + "PE_CONS_TRAN_ESTIM_TRN", "EjecutarResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mx.babel.bansefi.banksystem.base.webservices.consultaperfiltransaccional
     * 
     */
