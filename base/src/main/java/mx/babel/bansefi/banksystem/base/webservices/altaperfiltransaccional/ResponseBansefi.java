 ...
 *       &lt;sequence>
 *         &lt;element name="OPE_ALTA_INDV_PERF_TRAN_T">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "opealtaindvperftrant"
})
public class ResponseBansefi {

    @XmlElement(name = "OPE_ALTA_INDV_PERF_TRAN_T", required = true)
    protected ResponseBansefi.OPEALTAINDVPERFTRANT opealtaindvperftrant;

    /**
     * Obtiene el valor de la propiedad opealtaindvperftrant.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OPEALTAINDVPERFTRANT }
     *     
     */
    public ResponseBansefi.OPEALTAINDVPERFTRANT getOPEALTAINDVPERFTRANT() {
        return opealtaindvperftrant;
    }

    /**
     * Define el valor de la propiedad opealtaindvperftrant.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OPEALTAINDVPERFTRANT }
     *     
     */
    public void setOPEALTAINDVPERFTRANT(ResponseBansefi.OPEALTAINDVPERFTRANT value) {
        this.opealtaindvperftrant = value;
    }
    ...
    public static class OPEALTAINDVPERFTRANT {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OPEALTAINDVPERFTRANT.STDTRNOPARMV value) {
