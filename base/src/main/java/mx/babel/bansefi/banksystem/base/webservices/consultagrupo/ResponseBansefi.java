 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_GR_CONS_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_GR_CONS_TRN_O", required = true)
    protected ResponseBansefi.OTRGRCONSTRNO otrgrconstrno;

    /**
     * Obtiene el valor de la propiedad otrgrconstrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRGRCONSTRNO }
     *     
     */
    public ResponseBansefi.OTRGRCONSTRNO getOTRGRCONSTRNO() {
        return otrgrconstrno;
    }

    /**
     * Define el valor de la propiedad otrgrconstrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRGRCONSTRNO }
     *     
     */
    public void setOTRGRCONSTRNO(ResponseBansefi.OTRGRCONSTRNO value) {
        this.otrgrconstrno = value;
    }
    ...
    public static class OTRGRCONSTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_GR_CONS_EVT_Z", required = true)
        protected ResponseBansefi.OTRGRCONSTRNO.TRGRCONSEVTZ trgrconsevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRGRCONSTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRGRCONSTRNO.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRGRCONSTRNO.TRGRCONSEVTZ }
         *     
         */
        public ResponseBansefi.OTRGRCONSTRNO.TRGRCONSEVTZ getTRGRCONSEVTZ() {
            return trgrconsevtz;
        }
         ...
         *     
         */
        public void setTRGRCONSEVTZ(ResponseBansefi.OTRGRCONSTRNO.TRGRCONSEVTZ value) {
         ...
         * {@link ResponseBansefi.OTRGRCONSTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRGRCONSTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRGRCONSTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRGRCONSTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRGRCONSTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRGRCONSTRNO.STDTRNOPARMV value) {
