 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_CUADRE_HOST_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_CUADRE_HOST_TRN_O", required = true)
    protected ResponseBansefi.OTRCUADREHOSTTRNO otrcuadrehosttrno;

    /**
     * Obtiene el valor de la propiedad otrcuadrehosttrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRCUADREHOSTTRNO }
     *     
     */
    public ResponseBansefi.OTRCUADREHOSTTRNO getOTRCUADREHOSTTRNO() {
        return otrcuadrehosttrno;
    }

    /**
     * Define el valor de la propiedad otrcuadrehosttrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRCUADREHOSTTRNO }
     *     
     */
    public void setOTRCUADREHOSTTRNO(ResponseBansefi.OTRCUADREHOSTTRNO value) {
        this.otrcuadrehosttrno = value;
    }
    ...
    public static class OTRCUADREHOSTTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRCUADREHOSTTRNO.STDMSJPARMV> stdmsjparmv;
         ...
         * {@link ResponseBansefi.OTRCUADREHOSTTRNO.STDMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRCUADREHOSTTRNO.STDMSJPARMV> getSTDMSJPARMV() {
            if (stdmsjparmv == null) {
                stdmsjparmv = new ArrayList<ResponseBansefi.OTRCUADREHOSTTRNO.STDMSJPARMV>();
            }
