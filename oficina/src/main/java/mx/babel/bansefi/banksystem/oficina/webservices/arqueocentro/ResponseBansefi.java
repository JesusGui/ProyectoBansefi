 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_ARQUEO_CAJA_EX_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_ARQUEO_CAJA_EX_TRN_O", required = true)
    protected ResponseBansefi.OTRARQUEOCAJAEXTRNO otrarqueocajaextrno;

    /**
     * Obtiene el valor de la propiedad otrarqueocajaextrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRARQUEOCAJAEXTRNO }
     *     
     */
    public ResponseBansefi.OTRARQUEOCAJAEXTRNO getOTRARQUEOCAJAEXTRNO() {
        return otrarqueocajaextrno;
    }

    /**
     * Define el valor de la propiedad otrarqueocajaextrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRARQUEOCAJAEXTRNO }
     *     
     */
    public void setOTRARQUEOCAJAEXTRNO(ResponseBansefi.OTRARQUEOCAJAEXTRNO value) {
        this.otrarqueocajaextrno = value;
    }
    ...
    public static class OTRARQUEOCAJAEXTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNOPARMV stdtrnoparmv;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNOPARMV value) {
         ...
         * {@link ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRARQUEOCAJAEXTRNO.STDTRNMSJPARMV>();
            }
