 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_SUSPENDER_AC_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_SUSPENDER_AC_TRN_O", required = true)
    protected ResponseBansefi.OTRSUSPENDERACTRNO otrsuspenderactrno;

    /**
     * Obtiene el valor de la propiedad otrsuspenderactrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRSUSPENDERACTRNO }
     *     
     */
    public ResponseBansefi.OTRSUSPENDERACTRNO getOTRSUSPENDERACTRNO() {
        return otrsuspenderactrno;
    }

    /**
     * Define el valor de la propiedad otrsuspenderactrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRSUSPENDERACTRNO }
     *     
     */
    public void setOTRSUSPENDERACTRNO(ResponseBansefi.OTRSUSPENDERACTRNO value) {
        this.otrsuspenderactrno = value;
    }
    ...
    public static class OTRSUSPENDERACTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRSUSPENDERACTRNO.STDTRNOPARMV value) {
