 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_CANCE_TRAMI_AC_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_CANCE_TRAMI_AC_TRN_O", required = true)
    protected ResponseBansefi.OTRCANCETRAMIACTRNO otrcancetramiactrno;

    /**
     * Obtiene el valor de la propiedad otrcancetramiactrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRCANCETRAMIACTRNO }
     *     
     */
    public ResponseBansefi.OTRCANCETRAMIACTRNO getOTRCANCETRAMIACTRNO() {
        return otrcancetramiactrno;
    }

    /**
     * Define el valor de la propiedad otrcancetramiactrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRCANCETRAMIACTRNO }
     *     
     */
    public void setOTRCANCETRAMIACTRNO(ResponseBansefi.OTRCANCETRAMIACTRNO value) {
        this.otrcancetramiactrno = value;
    }
    ...
    public static class OTRCANCETRAMIACTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNOPARMV stdtrnoparmv;
        @XmlElement(name = "ACUERDO_2_V", required = true)
        protected ResponseBansefi.OTRCANCETRAMIACTRNO.ACUERDO2V acuerdo2V;
         ...
         * {@link ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRCANCETRAMIACTRNO.STDTRNOPARMV value) {
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRCANCETRAMIACTRNO.ACUERDO2V }
         *     
         */
        public ResponseBansefi.OTRCANCETRAMIACTRNO.ACUERDO2V getACUERDO2V() {
            return acuerdo2V;
        }
         ...
         *     
         */
        public void setACUERDO2V(ResponseBansefi.OTRCANCETRAMIACTRNO.ACUERDO2V value) {
