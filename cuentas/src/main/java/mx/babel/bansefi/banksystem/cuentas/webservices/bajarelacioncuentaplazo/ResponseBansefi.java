 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_BAJA_RL_IMPSCN_PAG_TR">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrbajarlimpscnpagtr"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_BAJA_RL_IMPSCN_PAG_TR", required = true)
    protected ResponseBansefi.OTRBAJARLIMPSCNPAGTR otrbajarlimpscnpagtr;

    /**
     * Obtiene el valor de la propiedad otrbajarlimpscnpagtr.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRBAJARLIMPSCNPAGTR }
     *     
     */
    public ResponseBansefi.OTRBAJARLIMPSCNPAGTR getOTRBAJARLIMPSCNPAGTR() {
        return otrbajarlimpscnpagtr;
    }

    /**
     * Define el valor de la propiedad otrbajarlimpscnpagtr.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRBAJARLIMPSCNPAGTR }
     *     
     */
    public void setOTRBAJARLIMPSCNPAGTR(ResponseBansefi.OTRBAJARLIMPSCNPAGTR value) {
        this.otrbajarlimpscnpagtr = value;
    }
    ...
    public static class OTRBAJARLIMPSCNPAGTR {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRBAJARLIMPSCNPAGTR.STDTRNOPARMV value) {
