 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_BAJA_BLOQUEO_PRTCN_TR">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrbajabloqueoprtcntr"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_BAJA_BLOQUEO_PRTCN_TR", required = true)
    protected ResponseBansefi.OTRBAJABLOQUEOPRTCNTR otrbajabloqueoprtcntr;

    /**
     * Obtiene el valor de la propiedad otrbajabloqueoprtcntr.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRBAJABLOQUEOPRTCNTR }
     *     
     */
    public ResponseBansefi.OTRBAJABLOQUEOPRTCNTR getOTRBAJABLOQUEOPRTCNTR() {
        return otrbajabloqueoprtcntr;
    }

    /**
     * Define el valor de la propiedad otrbajabloqueoprtcntr.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRBAJABLOQUEOPRTCNTR }
     *     
     */
    public void setOTRBAJABLOQUEOPRTCNTR(ResponseBansefi.OTRBAJABLOQUEOPRTCNTR value) {
        this.otrbajabloqueoprtcntr = value;
    }
    ...
    public static class OTRBAJABLOQUEOPRTCNTR {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRBAJABLOQUEOPRTCNTR.STDTRNOPARMV value) {
