 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_KP_CNS_LST_SMPL_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_KP_CNS_LST_SMPL_EVT_Z">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 ...
 *                               &lt;/simpleType>
 *                             &lt;/element>
 *                             &lt;element name="KP_LISDOM_SMPL_V">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 *                                       &lt;element name="KP_LISTA_SMPL_V" maxOccurs="50">
 *                                         &lt;complexType>
 *                                           &lt;complexContent>
 *                                             &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                               &lt;sequence>
 ...
 *                               &lt;/complexType>
 *                             &lt;/element>
 *                             &lt;element name="KP_LISDOM_DESCR_V" maxOccurs="50">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 ...
 *                               &lt;/complexType>
 *                             &lt;/element>
 *                             &lt;element name="IND_ACCION_CHAR_V" maxOccurs="50">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_KP_CNS_LST_SMPL_TRN_O", required = true)
    protected ResponseBansefi.OTRKPCNSLSTSMPLTRNO otrkpcnslstsmpltrno;

    /**
     * Obtiene el valor de la propiedad otrkpcnslstsmpltrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO }
     *     
     */
    public ResponseBansefi.OTRKPCNSLSTSMPLTRNO getOTRKPCNSLSTSMPLTRNO() {
        return otrkpcnslstsmpltrno;
    }

    /**
     * Define el valor de la propiedad otrkpcnslstsmpltrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO }
     *     
     */
    public void setOTRKPCNSLSTSMPLTRNO(ResponseBansefi.OTRKPCNSLSTSMPLTRNO value) {
        this.otrkpcnslstsmpltrno = value;
    }
    ...
    public static class OTRKPCNSLSTSMPLTRNO {
        ...
        @XmlElement(name = "TR_KP_CNS_LST_SMPL_EVT_Z", required = true)
        protected ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ trkpcnslstsmplevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trkpcnslstsmplevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ }
         *     
         */
        public ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ getTRKPCNSLSTSMPLEVTZ() {
            return trkpcnslstsmplevtz;
        }

        /**
         * Define el valor de la propiedad trkpcnslstsmplevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ }
         *     
         */
        public void setTRKPCNSLSTSMPLEVTZ(ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ value) {
            this.trkpcnslstsmplevtz = value;
        }
         ...
         * {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRKPCNSLSTSMPLTRNO.STDTRNOPARMV value) {
        ...
        public static class TRKPCNSLSTSMPLEVTZ {

            @XmlElement(name = "KP_CONTROL_TBL_V", required = true)
            protected ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPCONTROLTBLV kpcontroltblv;
            ...
            @XmlElement(name = "KP_LISDOM_SMPL_V", required = true)
            protected ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV kplisdomsmplv;
            @XmlElement(name = "KP_LISDOM_DESCR_V", required = true)
            protected List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMDESCRV> kplisdomdescrv;
            @XmlElement(name = "IND_ACCION_CHAR_V", required = true)
            protected List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.INDACCIONCHARV> indaccioncharv;
             ...
             * @return
             *     possible object is
             *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPCONTROLTBLV }
             *     
             */
            public ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPCONTROLTBLV getKPCONTROLTBLV() {
             ...
             *     
             */
            public void setKPCONTROLTBLV(ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPCONTROLTBLV value) {
            ...
            /**
             * Obtiene el valor de la propiedad kplisdomsmplv.
             * 
             * @return
             *     possible object is
             *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV }
             *     
             */
            public ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV getKPLISDOMSMPLV() {
                return kplisdomsmplv;
            }

            /**
             * Define el valor de la propiedad kplisdomsmplv.
             * 
             * @param value
             *     allowed object is
             *     {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV }
             *     
             */
            public void setKPLISDOMSMPLV(ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV value) {
                this.kplisdomsmplv = value;
            }

            /**
             * Gets the value of the kplisdomdescrv property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the kplisdomdescrv property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getKPLISDOMDESCRV().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMDESCRV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMDESCRV> getKPLISDOMDESCRV() {
                if (kplisdomdescrv == null) {
                    kplisdomdescrv = new ArrayList<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMDESCRV>();
                }
                return this.kplisdomdescrv;
            }

            /**
             * Gets the value of the indaccioncharv property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the indaccioncharv property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getINDACCIONCHARV().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.INDACCIONCHARV }
             * 
             * 
             */
            public List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.INDACCIONCHARV> getINDACCIONCHARV() {
                if (indaccioncharv == null) {
                    indaccioncharv = new ArrayList<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.INDACCIONCHARV>();
                }
                return this.indaccioncharv;
            }
            ...
            public static class INDACCIONCHARV {
            ...
            public static class KPLISDOMDESCRV {
                 ...
                 *     
                 */
                public void setTXTDOMPARMCD(String value) {
            ...
            public static class KPLISDOMSMPLV {

                @XmlElement(name = "KP_LISTA_SMPL_V", required = true)
                protected List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV.KPLISTASMPLV> kplistasmplv;
                 ...
                 * <p>
                 * Objects of the following type(s) are allowed in the list
                 * {@link ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV.KPLISTASMPLV }
                 * 
                 * 
                 */
                public List<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV.KPLISTASMPLV> getKPLISTASMPLV() {
                    if (kplistasmplv == null) {
                        kplistasmplv = new ArrayList<ResponseBansefi.OTRKPCNSLSTSMPLTRNO.TRKPCNSLSTSMPLEVTZ.KPLISDOMSMPLV.KPLISTASMPLV>();
                    }
