 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_MODIFICAR_KS_VLS_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_MODIFICAR_KS_VLS_EVT_Z">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrmodificarksvlstrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_MODIFICAR_KS_VLS_TRN", required = true)
    protected ResponseBansefi.OTRMODIFICARKSVLSTRN otrmodificarksvlstrn;

    /**
     * Obtiene el valor de la propiedad otrmodificarksvlstrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRMODIFICARKSVLSTRN }
     *     
     */
    public ResponseBansefi.OTRMODIFICARKSVLSTRN getOTRMODIFICARKSVLSTRN() {
        return otrmodificarksvlstrn;
    }

    /**
     * Define el valor de la propiedad otrmodificarksvlstrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRMODIFICARKSVLSTRN }
     *     
     */
    public void setOTRMODIFICARKSVLSTRN(ResponseBansefi.OTRMODIFICARKSVLSTRN value) {
        this.otrmodificarksvlstrn = value;
    }
    ...
    @XmlType(name = "", propOrder = {
        "rtrncd",
        "trmodificarksvlsevtz",
        "stdtrnmsjparmv",
        "stdtrnoparmv"
    })
    public static class OTRMODIFICARKSVLSTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_MODIFICAR_KS_VLS_EVT_Z", required = true)
        protected ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ trmodificarksvlsevtz;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNOPARMV stdtrnoparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trmodificarksvlsevtz.
         * 
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ }
         *     
         */
        public ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ getTRMODIFICARKSVLSEVTZ() {
            return trmodificarksvlsevtz;
        }

        /**
         * Define el valor de la propiedad trmodificarksvlsevtz.
         * 
         * @param value
         *     allowed object is
         *     {@link ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ }
         *     
         */
        public void setTRMODIFICARKSVLSEVTZ(ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ value) {
            this.trmodificarksvlsevtz = value;
        }
         ...
         * {@link ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRMODIFICARKSVLSTRN.STDTRNOPARMV value) {
        ...
        public static class TRMODIFICARKSVLSEVTZ {

            @XmlElement(name = "RESULT_VAL_ATRIB_V", required = true)
            protected ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.RESULTVALATRIBV resultvalatribv;
            @XmlElement(name = "PORC_ATRIB_NEC_V", required = true)
            protected ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.PORCATRIBNECV porcatribnecv;
             ...
             * @return
             *     possible object is
             *     {@link ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.RESULTVALATRIBV }
             *     
             */
            public ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.RESULTVALATRIBV getRESULTVALATRIBV() {
             ...
             *     
             */
            public void setRESULTVALATRIBV(ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.RESULTVALATRIBV value) {
             ...
             * @return
             *     possible object is
             *     {@link ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.PORCATRIBNECV }
             *     
             */
            public ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.PORCATRIBNECV getPORCATRIBNECV() {
             ...
             *     
             */
            public void setPORCATRIBNECV(ResponseBansefi.OTRMODIFICARKSVLSTRN.TRMODIFICARKSVLSEVTZ.PORCATRIBNECV value) {
