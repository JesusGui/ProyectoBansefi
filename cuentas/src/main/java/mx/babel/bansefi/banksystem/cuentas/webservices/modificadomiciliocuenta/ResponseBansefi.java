 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_MODIF_DIR_AC_TRN_O">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
public class ResponseBansefi {
    ...
    @XmlElement(name = "OTR_MODIF_DIR_AC_TRN_O", required = true)
    protected ResponseBansefi.OTRMODIFDIRACTRNO otrmodifdiractrno;

    /**
     * Obtiene el valor de la propiedad otrmodifdiractrno.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRMODIFDIRACTRNO }
     *     
     */
    public ResponseBansefi.OTRMODIFDIRACTRNO getOTRMODIFDIRACTRNO() {
        return otrmodifdiractrno;
    }

    /**
     * Define el valor de la propiedad otrmodifdiractrno.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRMODIFDIRACTRNO }
     *     
     */
    public void setOTRMODIFDIRACTRNO(ResponseBansefi.OTRMODIFDIRACTRNO value) {
        this.otrmodifdiractrno = value;
    }
    ...
    public static class OTRMODIFDIRACTRNO {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRMODIFDIRACTRNO.STDTRNOPARMV value) {
