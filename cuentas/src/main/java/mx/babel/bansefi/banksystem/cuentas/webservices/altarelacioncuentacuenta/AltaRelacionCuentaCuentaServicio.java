...
public class AltaRelacionCuentaCuentaServicio extends Service {
    ...
    public final static QName SERVICE = new QName(ServicioWebConstants.TARGETNAMESPACE_TRN + "TR_ALTA_RX_PANT_TRN", "TR_ALTA_RX_PANT_TRN");
    public final static QName SoapPort = new QName(ServicioWebConstants.TARGETNAMESPACE_TRN + "TR_ALTA_RX_PANT_TRN", "SoapPort");
    static {
        URL url = null;
        try {
            url = new URL(ServicioWebConstants.URL_WSDL+"TR_ALTA_RX_PANT_TRN/WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AltaRelacionCuentaCuentaServicio.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", ServicioWebConstants.URL_WSDL+"TR_ALTA_RX_PANT_TRN/WSDL");
        }
        WSDL_LOCATION = url;
    }
