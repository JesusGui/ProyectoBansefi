...
package mx.babel.bansefi.banksystem.cuentas.webservices.modificacionrelacioncuentaplazo;
 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_MDF_RL_IMPSCN_PAG_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrmdfrlimpscnpagtrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_MDF_RL_IMPSCN_PAG_TRN", required = true)
    protected ResponseBansefi.OTRMDFRLIMPSCNPAGTRN otrmdfrlimpscnpagtrn;

    /**
     * Obtiene el valor de la propiedad otrmdfrlimpscnpagtrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRMDFRLIMPSCNPAGTRN }
     *     
     */
    public ResponseBansefi.OTRMDFRLIMPSCNPAGTRN getOTRMDFRLIMPSCNPAGTRN() {
        return otrmdfrlimpscnpagtrn;
    }

    /**
     * Define el valor de la propiedad otrmdfrlimpscnpagtrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRMDFRLIMPSCNPAGTRN }
     *     
     */
    public void setOTRMDFRLIMPSCNPAGTRN(ResponseBansefi.OTRMDFRLIMPSCNPAGTRN value) {
        this.otrmdfrlimpscnpagtrn = value;
    }
    ...
    public static class OTRMDFRLIMPSCNPAGTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRMDFRLIMPSCNPAGTRN.STDTRNOPARMV value) {
