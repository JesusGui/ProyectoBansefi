 ...
 *         &lt;element name="ITR_SUSPENDER_AC_TRN_I">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="TR_SUSPENDER_AC_EVT_Y">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="F_DESDE_HASTA_V">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 ...
 *                               &lt;/complexType>
 *                             &lt;/element>
 *                             &lt;element name="F_DESDE_HASTA_ANTERIOR_V">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
...
public class Ejecutar {
    ...
    @XmlElement(name = "ITR_SUSPENDER_AC_TRN_I", required = true)
    protected Ejecutar.ITRSUSPENDERACTRNI itrsuspenderactrni;
    ...
    /**
     * Obtiene el valor de la propiedad itrsuspenderactrni.
     * 
     * @return
     *     possible object is
     *     {@link Ejecutar.ITRSUSPENDERACTRNI }
     *     
     */
    public Ejecutar.ITRSUSPENDERACTRNI getITRSUSPENDERACTRNI() {
        return itrsuspenderactrni;
    }

    /**
     * Define el valor de la propiedad itrsuspenderactrni.
     * 
     * @param value
     *     allowed object is
     *     {@link Ejecutar.ITRSUSPENDERACTRNI }
     *     
     */
    public void setITRSUSPENDERACTRNI(Ejecutar.ITRSUSPENDERACTRNI value) {
        this.itrsuspenderactrni = value;
    }
    ...
    public static class ITRSUSPENDERACTRNI {

        @XmlElement(name = "TR_SUSPENDER_AC_EVT_Y", required = true)
        protected Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY trsuspenderacevty;
        @XmlElement(name = "STD_TRN_I_PARM_V", required = true)
        protected Ejecutar.ITRSUSPENDERACTRNI.STDTRNIPARMV stdtrniparmv;

        /**
         * Obtiene el valor de la propiedad trsuspenderacevty.
         * 
         * @return
         *     possible object is
         *     {@link Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY }
         *     
         */
        public Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY getTRSUSPENDERACEVTY() {
            return trsuspenderacevty;
        }

        /**
         * Define el valor de la propiedad trsuspenderacevty.
         * 
         * @param value
         *     allowed object is
         *     {@link Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY }
         *     
         */
        public void setTRSUSPENDERACEVTY(Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY value) {
            this.trsuspenderacevty = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Ejecutar.ITRSUSPENDERACTRNI.STDTRNIPARMV }
         *     
         */
        public Ejecutar.ITRSUSPENDERACTRNI.STDTRNIPARMV getSTDTRNIPARMV() {
            return stdtrniparmv;
        }
         ...
         *     
         */
        public void setSTDTRNIPARMV(Ejecutar.ITRSUSPENDERACTRNI.STDTRNIPARMV value) {
        ...
        @XmlType(name = "", propOrder = {
            "fdesdehastav",
            "fdesdehastaanteriorv",
            "horaplanif",
            "acacp"
        })
        public static class TRSUSPENDERACEVTY {

            @XmlElement(name = "F_DESDE_HASTA_V", required = true)
            protected Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAV fdesdehastav;
            @XmlElement(name = "F_DESDE_HASTA_ANTERIOR_V", required = true)
            protected Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAANTERIORV fdesdehastaanteriorv;
            @XmlElement(name = "HORA_PLANIF")
            protected int horaplanif;
            @XmlElement(name = "AC_AC_P", required = true)
            protected Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.ACACP acacp;

            /**
             * Obtiene el valor de la propiedad fdesdehastav.
             * 
             * @return
             *     possible object is
             *     {@link Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAV }
             *     
             */
            public Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAV getFDESDEHASTAV() {
                return fdesdehastav;
            }

            /**
             * Define el valor de la propiedad fdesdehastav.
             * 
             * @param value
             *     allowed object is
             *     {@link Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAV }
             *     
             */
            public void setFDESDEHASTAV(Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAV value) {
                this.fdesdehastav = value;
            }

            /**
             * Obtiene el valor de la propiedad fdesdehastaanteriorv.
             * 
             * @return
             *     possible object is
             *     {@link Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAANTERIORV }
             *     
             */
            public Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAANTERIORV getFDESDEHASTAANTERIORV() {
                return fdesdehastaanteriorv;
            }

            /**
             * Define el valor de la propiedad fdesdehastaanteriorv.
             * 
             * @param value
             *     allowed object is
             *     {@link Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAANTERIORV }
             *     
             */
            public void setFDESDEHASTAANTERIORV(Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.FDESDEHASTAANTERIORV value) {
                this.fdesdehastaanteriorv = value;
            }
             ...
             * @return
             *     possible object is
             *     {@link Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.ACACP }
             *     
             */
            public Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.ACACP getACACP() {
                return acacp;
            }
             ...
             *     
             */
            public void setACACP(Ejecutar.ITRSUSPENDERACTRNI.TRSUSPENDERACEVTY.ACACP value) {
                this.acacp = value;
            }
            ...
            public static class FDESDEHASTAANTERIORV {

                @XmlElement(name = "STD_FECHA")
                protected int stdfecha;
                @XmlElement(name = "STD_FECHA_2")
                protected int stdfecha2;
                ...
                /**
                 * Obtiene el valor de la propiedad stdfecha2.
                 * 
                 */
                public int getSTDFECHA2() {
                    return stdfecha2;
                }

                /**
                 * Define el valor de la propiedad stdfecha2.
                 * 
                 */
                public void setSTDFECHA2(int value) {
                    this.stdfecha2 = value;
                }
            ...
            public static class FDESDEHASTAV {
