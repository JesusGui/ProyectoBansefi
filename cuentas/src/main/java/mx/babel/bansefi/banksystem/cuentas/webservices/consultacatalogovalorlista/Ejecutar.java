 ...
 *         &lt;element name="ITR_KP_CNS_LST_SMPL_TRN_I">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_KP_CNS_LST_SMPL_EVT_Y">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="KP_COD_CLAVE_V">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 ...
 *                               &lt;/complexType>
 *                             &lt;/element>
 *                             &lt;element name="KP_FECHA_V">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 *                                       &lt;element name="FECHA_ENT">
 *                                         &lt;simpleType>
 *                                           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}integer">
 *                                             &lt;maxInclusive value="99999999"/>
 *                                             &lt;minInclusive value="0"/>
...
public class Ejecutar {
    ...
    @XmlElement(name = "ITR_KP_CNS_LST_SMPL_TRN_I", required = true)
    protected Ejecutar.ITRKPCNSLSTSMPLTRNI itrkpcnslstsmpltrni;
    ...
    /**
     * Obtiene el valor de la propiedad itrkpcnslstsmpltrni.
     * 
     * @return
     *     possible object is
     *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI }
     *     
     */
    public Ejecutar.ITRKPCNSLSTSMPLTRNI getITRKPCNSLSTSMPLTRNI() {
        return itrkpcnslstsmpltrni;
    }

    /**
     * Define el valor de la propiedad itrkpcnslstsmpltrni.
     * 
     * @param value
     *     allowed object is
     *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI }
     *     
     */
    public void setITRKPCNSLSTSMPLTRNI(Ejecutar.ITRKPCNSLSTSMPLTRNI value) {
        this.itrkpcnslstsmpltrni = value;
    }
    ...
    public static class ITRKPCNSLSTSMPLTRNI {
        ...
        @XmlElement(name = "TR_KP_CNS_LST_SMPL_EVT_Y", required = true)
        protected Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY trkpcnslstsmplevty;
        @XmlElement(name = "STD_TRN_I_PARM_V", required = true)
        protected Ejecutar.ITRKPCNSLSTSMPLTRNI.STDTRNIPARMV stdtrniparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trkpcnslstsmplevty.
         * 
         * @return
         *     possible object is
         *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY }
         *     
         */
        public Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY getTRKPCNSLSTSMPLEVTY() {
            return trkpcnslstsmplevty;
        }

        /**
         * Define el valor de la propiedad trkpcnslstsmplevty.
         * 
         * @param value
         *     allowed object is
         *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY }
         *     
         */
        public void setTRKPCNSLSTSMPLEVTY(Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY value) {
            this.trkpcnslstsmplevty = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI.STDTRNIPARMV }
         *     
         */
        public Ejecutar.ITRKPCNSLSTSMPLTRNI.STDTRNIPARMV getSTDTRNIPARMV() {
            return stdtrniparmv;
        }
         ...
         *     
         */
        public void setSTDTRNIPARMV(Ejecutar.ITRKPCNSLSTSMPLTRNI.STDTRNIPARMV value) {
        ...
        public static class TRKPCNSLSTSMPLEVTY {

            @XmlElement(name = "KP_COD_CLAVE_V", required = true)
            protected Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPCODCLAVEV kpcodclavev;
            @XmlElement(name = "KP_FECHA_V", required = true)
            protected Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPFECHAV kpfechav;
            @XmlElement(name = "NOMB_CCPS", required = true)
            protected String nombccps;

            /**
             * Obtiene el valor de la propiedad kpcodclavev.
             * 
             * @return
             *     possible object is
             *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPCODCLAVEV }
             *     
             */
            public Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPCODCLAVEV getKPCODCLAVEV() {
                return kpcodclavev;
            }

            /**
             * Define el valor de la propiedad kpcodclavev.
             * 
             * @param value
             *     allowed object is
             *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPCODCLAVEV }
             *     
             */
            public void setKPCODCLAVEV(Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPCODCLAVEV value) {
                this.kpcodclavev = value;
            }

            /**
             * Obtiene el valor de la propiedad kpfechav.
             * 
             * @return
             *     possible object is
             *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPFECHAV }
             *     
             */
            public Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPFECHAV getKPFECHAV() {
                return kpfechav;
            }

            /**
             * Define el valor de la propiedad kpfechav.
             * 
             * @param value
             *     allowed object is
             *     {@link Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPFECHAV }
             *     
             */
            public void setKPFECHAV(Ejecutar.ITRKPCNSLSTSMPLTRNI.TRKPCNSLSTSMPLEVTY.KPFECHAV value) {
                this.kpfechav = value;
            }
            ...
            public static class KPCODCLAVEV {
            ...
            public static class KPFECHAV {

                @XmlElement(name = "FECHA_ENT")
                protected int fechaent;
                 ...
                 * 
                 */
                public void setFECHAENT(int value) {
                    this.fechaent = value;
                }
