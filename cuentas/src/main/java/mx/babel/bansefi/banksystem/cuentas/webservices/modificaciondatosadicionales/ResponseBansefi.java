 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_MODIF_AMPLIAR_AC_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrmodifampliaractrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_MODIF_AMPLIAR_AC_TRN", required = true)
    protected ResponseBansefi.OTRMODIFAMPLIARACTRN otrmodifampliaractrn;

    /**
     * Obtiene el valor de la propiedad otrmodifampliaractrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRMODIFAMPLIARACTRN }
     *     
     */
    public ResponseBansefi.OTRMODIFAMPLIARACTRN getOTRMODIFAMPLIARACTRN() {
        return otrmodifampliaractrn;
    }

    /**
     * Define el valor de la propiedad otrmodifampliaractrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRMODIFAMPLIARACTRN }
     *     
     */
    public void setOTRMODIFAMPLIARACTRN(ResponseBansefi.OTRMODIFAMPLIARACTRN value) {
        this.otrmodifampliaractrn = value;
    }
    ...
    public static class OTRMODIFAMPLIARACTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * {@link ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRMODIFAMPLIARACTRN.STDTRNOPARMV value) {
