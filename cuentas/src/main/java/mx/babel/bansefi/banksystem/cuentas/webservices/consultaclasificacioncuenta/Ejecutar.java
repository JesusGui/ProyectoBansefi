 ...
 *       &lt;sequence>
 *         &lt;element name="TR_CONSU_DATOS_AC_TRN_I">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                     &lt;/simpleType>
 *                   &lt;/element>
 *                   &lt;element name="TR_CONSU_DATOS_AC_EVT_Y">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
...
public class Ejecutar {
    ...
    @XmlElement(name = "TR_CONSU_DATOS_AC_TRN_I", required = true)
    protected Ejecutar.TRCONSUDATOSACTRNI trconsudatosactrni;

    /**
     * Obtiene el valor de la propiedad trconsudatosactrni.
     * 
     * @return
     *     possible object is
     *     {@link Ejecutar.TRCONSUDATOSACTRNI }
     *     
     */
    public Ejecutar.TRCONSUDATOSACTRNI getTRCONSUDATOSACTRNI() {
        return trconsudatosactrni;
    }

    /**
     * Define el valor de la propiedad trconsudatosactrni.
     * 
     * @param value
     *     allowed object is
     *     {@link Ejecutar.TRCONSUDATOSACTRNI }
     *     
     */
    public void setTRCONSUDATOSACTRNI(Ejecutar.TRCONSUDATOSACTRNI value) {
        this.trconsudatosactrni = value;
    }
    ...
    public static class TRCONSUDATOSACTRNI {
        ...
        @XmlElement(name = "TR_CONSU_DATOS_AC_EVT_Y", required = true)
        protected Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY trconsudatosacevty;
        @XmlElement(name = "STD_TRN_I_PARM_V", required = true)
        protected Ejecutar.TRCONSUDATOSACTRNI.STDTRNIPARMV stdtrniparmv;
        ...
        /**
         * Obtiene el valor de la propiedad trconsudatosacevty.
         * 
         * @return
         *     possible object is
         *     {@link Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY }
         *     
         */
        public Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY getTRCONSUDATOSACEVTY() {
            return trconsudatosacevty;
        }

        /**
         * Define el valor de la propiedad trconsudatosacevty.
         * 
         * @param value
         *     allowed object is
         *     {@link Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY }
         *     
         */
        public void setTRCONSUDATOSACEVTY(Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY value) {
            this.trconsudatosacevty = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Ejecutar.TRCONSUDATOSACTRNI.STDTRNIPARMV }
         *     
         */
        public Ejecutar.TRCONSUDATOSACTRNI.STDTRNIPARMV getSTDTRNIPARMV() {
            return stdtrniparmv;
        }
         ...
         *     
         */
        public void setSTDTRNIPARMV(Ejecutar.TRCONSUDATOSACTRNI.STDTRNIPARMV value) {
        ...
        public static class TRCONSUDATOSACEVTY {

            @XmlElement(name = "AC_AC_P", required = true)
            protected Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY.ACACP acacp;
             ...
             * @return
             *     possible object is
             *     {@link Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY.ACACP }
             *     
             */
            public Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY.ACACP getACACP() {
                return acacp;
            }
             ...
             *     
             */
            public void setACACP(Ejecutar.TRCONSUDATOSACTRNI.TRCONSUDATOSACEVTY.ACACP value) {
                this.acacp = value;
            }
