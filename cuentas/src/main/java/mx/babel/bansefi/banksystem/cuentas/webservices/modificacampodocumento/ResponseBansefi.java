 ...
 *       &lt;sequence>
 *         &lt;element name="OTR_DE_MODI_DATOS_ENT_TRN">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlType(name = "ResponseBansefi", propOrder = {
    "otrdemodidatosenttrn"
})
public class ResponseBansefi {

    @XmlElement(name = "OTR_DE_MODI_DATOS_ENT_TRN", required = true)
    protected ResponseBansefi.OTRDEMODIDATOSENTTRN otrdemodidatosenttrn;

    /**
     * Obtiene el valor de la propiedad otrdemodidatosenttrn.
     * 
     * @return
     *     possible object is
     *     {@link ResponseBansefi.OTRDEMODIDATOSENTTRN }
     *     
     */
    public ResponseBansefi.OTRDEMODIDATOSENTTRN getOTRDEMODIDATOSENTTRN() {
        return otrdemodidatosenttrn;
    }

    /**
     * Define el valor de la propiedad otrdemodidatosenttrn.
     * 
     * @param value
     *     allowed object is
     *     {@link ResponseBansefi.OTRDEMODIDATOSENTTRN }
     *     
     */
    public void setOTRDEMODIDATOSENTTRN(ResponseBansefi.OTRDEMODIDATOSENTTRN value) {
        this.otrdemodidatosenttrn = value;
    }
    ...
    public static class OTRDEMODIDATOSENTTRN {

        @XmlElement(name = "RTRN_CD")
        protected int rtrncd;
        @XmlElement(name = "TR_DE_MODI_DATOS_ENT_EVT", required = true)
        protected ResponseBansefi.OTRDEMODIDATOSENTTRN.TRDEMODIDATOSENTEVT trdemodidatosentevt;
        @XmlElement(name = "STD_TRN_MSJ_PARM_V", required = true)
        protected List<ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNMSJPARMV> stdtrnmsjparmv;
        @XmlElement(name = "STD_TRN_O_PARM_V", required = true)
        protected ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNOPARMV stdtrnoparmv;
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRDEMODIDATOSENTTRN.TRDEMODIDATOSENTEVT }
         *     
         */
        public ResponseBansefi.OTRDEMODIDATOSENTTRN.TRDEMODIDATOSENTEVT getTRDEMODIDATOSENTEVT() {
         ...
         *     
         */
        public void setTRDEMODIDATOSENTEVT(ResponseBansefi.OTRDEMODIDATOSENTTRN.TRDEMODIDATOSENTEVT value) {
         ...
         * {@link ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNMSJPARMV }
         * 
         * 
         */
        public List<ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNMSJPARMV> getSTDTRNMSJPARMV() {
            if (stdtrnmsjparmv == null) {
                stdtrnmsjparmv = new ArrayList<ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNMSJPARMV>();
            }
         ...
         * @return
         *     possible object is
         *     {@link ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNOPARMV }
         *     
         */
        public ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNOPARMV getSTDTRNOPARMV() {
            return stdtrnoparmv;
        }
         ...
         *     
         */
        public void setSTDTRNOPARMV(ResponseBansefi.OTRDEMODIDATOSENTTRN.STDTRNOPARMV value) {
